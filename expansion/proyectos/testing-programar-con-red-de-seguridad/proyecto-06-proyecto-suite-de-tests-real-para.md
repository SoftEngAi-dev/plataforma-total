# 🚀 Proyecto 6: Proyecto: suite de tests real para tu calculadora/app

> 📚 Testing — Programar con Red de Seguridad · Ancla: lección «5. Proyecto: suite de tests real para tu calculadora/app» · Apoyo: «1. Tests: por qué son parte del código, no un extra»
...
## 📦 Entregables
- [ ] Código en `proyectos/testing-programar-con-red-de-seguridad/proyecto-06/`
