# 🚀 Proyecto 1: Tests: por qué son parte del código, no un extra

> 📚 Testing — Programar con Red de Seguridad · Ancla: lección «1. Tests: por qué son parte del código, no un extra» · Apoyo: «2. Pytest, Jest y asserts: la gramática universal»
...
## 📦 Entregables
- [ ] Código en `proyectos/testing-programar-con-red-de-seguridad/proyecto-01/`
