# 🚀 Proyecto 5: FastAPI: APIs con Python + TypeScript feel

> 📚 APIs REST y HTTP — El Idioma de los Servidores · Ancla: lección «3. FastAPI: APIs con Python + TypeScript feel» · Apoyo: «4. Proyecto: API REST completa+cliente que la consume»
...
## 📦 Entregables
- [ ] Código en `proyectos/apis-rest-y-http-el-idioma-de-los-servidores/proyecto-05/`
