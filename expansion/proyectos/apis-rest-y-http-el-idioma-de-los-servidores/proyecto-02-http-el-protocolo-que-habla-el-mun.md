# 🚀 Proyecto 2: HTTP: el protocolo que habla el mundo

> 📚 APIs REST y HTTP — El Idioma de los Servidores · Ancla: lección «1. HTTP: el protocolo que habla el mundo» · Apoyo: «2. Diseñar tu API: recursos, URLs y convenciones»
...
## 📦 Entregables
- [ ] Código en `proyectos/apis-rest-y-http-el-idioma-de-los-servidores/proyecto-02/`
