# 🚀 Proyecto 6: Proyecto: API REST completa+cliente que la consume

> 📚 APIs REST y HTTP — El Idioma de los Servidores · Ancla: lección «4. Proyecto: API REST completa+cliente que la consume» · Apoyo: «1. HTTP: el protocolo que habla el mundo»
...
## 📦 Entregables
- [ ] Código en `proyectos/apis-rest-y-http-el-idioma-de-los-servidores/proyecto-06/`
