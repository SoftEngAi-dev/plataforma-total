# 🚀 Proyecto 3: Diseñar tu API: recursos, URLs y convenciones

> 📚 APIs REST y HTTP — El Idioma de los Servidores · Ancla: lección «2. Diseñar tu API: recursos, URLs y convenciones» · Apoyo: «3. FastAPI: APIs con Python + TypeScript feel»
...
## 📦 Entregables
- [ ] Código en `proyectos/apis-rest-y-http-el-idioma-de-los-servidores/proyecto-03/`
