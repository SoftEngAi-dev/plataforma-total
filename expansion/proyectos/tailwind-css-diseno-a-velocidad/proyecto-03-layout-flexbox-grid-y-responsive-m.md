# 🚀 Proyecto 3: Layout: flexbox, grid y responsive móvil primero

> 📚 🎨 Tailwind CSS — Diseño a Velocidad · Ancla: lección «2. Layout: flexbox, grid y responsive móvil primero» · Apoyo: «3. Estados y variantes: hover, dark: y group»
...
## 📦 Entregables
- [ ] Código en `proyectos/tailwind-css-diseno-a-velocidad/proyecto-03/`
