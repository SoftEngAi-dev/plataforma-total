# 🚀 Proyecto 4: Estados y variantes: hover, dark: y group

> 📚 🎨 Tailwind CSS — Diseño a Velocidad · Ancla: lección «3. Estados y variantes: hover, dark: y group» · Apoyo: «4. Personalizar el tema, @apply y valores arbitrarios»
...
## 📦 Entregables
- [ ] Código en `proyectos/tailwind-css-diseno-a-velocidad/proyecto-04/`
