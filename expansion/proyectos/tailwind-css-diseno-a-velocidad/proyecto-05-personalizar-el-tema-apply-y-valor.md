# 🚀 Proyecto 5: Personalizar el tema, @apply y valores arbitrarios

> 📚 🎨 Tailwind CSS — Diseño a Velocidad · Ancla: lección «4. Personalizar el tema, @apply y valores arbitrarios» · Apoyo: «5. Producción: shadcn/ui, accesibilidad y buenas prácticas»
...
## 📦 Entregables
- [ ] Código en `proyectos/tailwind-css-diseno-a-velocidad/proyecto-05/`
