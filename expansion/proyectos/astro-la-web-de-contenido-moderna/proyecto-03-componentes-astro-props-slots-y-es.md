# 🚀 Proyecto 3: Componentes Astro: props, slots y estilos con scope

> 📚 🚀 Astro — La Web de Contenido Moderna · Ancla: lección «2. Componentes Astro: props, slots y estilos con scope» · Apoyo: «3. Rutas por archivo, dinámicas y layouts»
...
## 📦 Entregables
- [ ] Código en `proyectos/astro-la-web-de-contenido-moderna/proyecto-03/`
