# 🚀 Proyecto 3: Mantener tu app viva: systemd, pm2 y reinicios

> 📚 Despliegue y Servidores — Tu App al Mundo · Ancla: lección «3. Mantener tu app viva: systemd, pm2 y reinicios» · Apoyo: «4. Bases de datos en producción: presupuesto mínimo de seriedad»
...
## 📦 Entregables
- [ ] Código en `proyectos/despliegue-y-servidores-tu-app-al-mundo/proyecto-03/`
