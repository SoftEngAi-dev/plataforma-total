# 🚀 Proyecto 6: Proyecto final: tu app COMPLETA en internet con dominio

> 📚 Despliegue y Servidores — Tu App al Mundo · Ancla: lección «6. Proyecto final: tu app COMPLETA en internet con dominio» · Apoyo: «1. Dónde puede vivir tu app: el menú de opciones»
...
## 📦 Entregables
- [ ] Código en `proyectos/despliegue-y-servidores-tu-app-al-mundo/proyecto-06/`
