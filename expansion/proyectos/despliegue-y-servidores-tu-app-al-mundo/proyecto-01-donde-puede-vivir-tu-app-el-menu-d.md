# 🚀 Proyecto 1: Dónde puede vivir tu app: el menú de opciones

> 📚 Despliegue y Servidores — Tu App al Mundo · Ancla: lección «1. Dónde puede vivir tu app: el menú de opciones» · Apoyo: «2. Nginx y reverse proxy: el portero de tu servidor»
...
## 📦 Entregables
- [ ] Código en `proyectos/despliegue-y-servidores-tu-app-al-mundo/proyecto-01/`
