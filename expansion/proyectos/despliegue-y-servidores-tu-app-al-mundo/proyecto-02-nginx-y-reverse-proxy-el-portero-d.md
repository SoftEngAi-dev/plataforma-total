# 🚀 Proyecto 2: Nginx y reverse proxy: el portero de tu servidor

> 📚 Despliegue y Servidores — Tu App al Mundo · Ancla: lección «2. Nginx y reverse proxy: el portero de tu servidor» · Apoyo: «3. Mantener tu app viva: systemd, pm2 y reinicios»
...
## 📦 Entregables
- [ ] Código en `proyectos/despliegue-y-servidores-tu-app-al-mundo/proyecto-02/`
