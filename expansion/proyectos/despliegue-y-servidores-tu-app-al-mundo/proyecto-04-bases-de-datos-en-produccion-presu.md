# 🚀 Proyecto 4: Bases de datos en producción: presupuesto mínimo de seriedad

> 📚 Despliegue y Servidores — Tu App al Mundo · Ancla: lección «4. Bases de datos en producción: presupuesto mínimo de seriedad» · Apoyo: «5. GitHub Pages y Netlify: tu estática en 5 minutos»
...
## 📦 Entregables
- [ ] Código en `proyectos/despliegue-y-servidores-tu-app-al-mundo/proyecto-04/`
