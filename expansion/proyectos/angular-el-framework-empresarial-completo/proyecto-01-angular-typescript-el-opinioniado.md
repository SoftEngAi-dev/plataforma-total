# 🚀 Proyecto 1: Angular + TypeScript: el opinioniado ganador empresa

> 📚 Angular — El Framework Empresarial Completo · Ancla: lección «1. Angular + TypeScript: el opinioniado ganador empresa» · Apoyo: «2. Servicios e inyección de dependencias: la joya oculta»
...
## 📦 Entregables
- [ ] Código en `proyectos/angular-el-framework-empresarial-completo/proyecto-01/`
