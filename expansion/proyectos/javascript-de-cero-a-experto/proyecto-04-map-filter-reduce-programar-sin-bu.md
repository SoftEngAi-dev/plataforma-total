# 🚀 Proyecto 4: map, filter, reduce: programar sin bucles

> 📚 JavaScript — De Cero a Experto · Ancla: lección «10. map, filter, reduce: programar sin bucles» · Apoyo: «11. Objetos: diccionarios con superpoderes»
...
## 📦 Entregables
- [ ] Código en `proyectos/javascript-de-cero-a-experto/proyecto-04/`
