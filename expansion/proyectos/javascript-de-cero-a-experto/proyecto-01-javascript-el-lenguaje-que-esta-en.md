# 🚀 Proyecto 1: JavaScript: el lenguaje que está en todas partes

> 📚 JavaScript — De Cero a Experto · Ancla: lección «1. JavaScript: el lenguaje que está en todas partes» · Apoyo: «2. Variables: let, const y por qué var quedó atrás»
...
## 📦 Entregables
- [ ] Código en `proyectos/javascript-de-cero-a-experto/proyecto-01/`
