# 🚀 Proyecto 5: El DOM: convertir HTML en objeto vivo

> 📚 JavaScript — De Cero a Experto · Ancla: lección «13. El DOM: convertir HTML en objeto vivo» · Apoyo: «14. Eventos: la web reacciona»
...
## 📦 Entregables
- [ ] Código en `proyectos/javascript-de-cero-a-experto/proyecto-05/`
