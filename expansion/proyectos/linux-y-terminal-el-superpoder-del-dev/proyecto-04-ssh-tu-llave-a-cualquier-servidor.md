# 🚀 Proyecto 4: SSH: tu llave a cualquier servidor

> 📚 Linux y Terminal — El Superpoder del Dev · Ancla: lección «4. SSH: tu llave a cualquier servidor» · Apoyo: «5. Scripts Bash: automatiza tu propia vida»
...
## 📦 Entregables
- [ ] Código en `proyectos/linux-y-terminal-el-superpoder-del-dev/proyecto-04/`
