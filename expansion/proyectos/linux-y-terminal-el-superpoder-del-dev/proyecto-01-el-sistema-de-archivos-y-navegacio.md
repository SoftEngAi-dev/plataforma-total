# 🚀 Proyecto 1: El sistema de archivos y navegación

> 📚 Linux y Terminal — El Superpoder del Dev · Ancla: lección «1. El sistema de archivos y navegación» · Apoyo: «2. Leer, buscar y tuberías: la filosofía Unix»
...
## 📦 Entregables
- [ ] Código en `proyectos/linux-y-terminal-el-superpoder-del-dev/proyecto-01/`
