# 🚀 Proyecto 6: Proyecto: pone tu PC a trabajar sola

> 📚 Linux y Terminal — El Superpoder del Dev · Ancla: lección «6. Proyecto: pone tu PC a trabajar sola» · Apoyo: «1. El sistema de archivos y navegación»
...
## 📦 Entregables
- [ ] Código en `proyectos/linux-y-terminal-el-superpoder-del-dev/proyecto-06/`
