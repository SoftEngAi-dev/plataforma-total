# 🚀 Proyecto 5: Scripts Bash: automatiza tu propia vida

> 📚 Linux y Terminal — El Superpoder del Dev · Ancla: lección «5. Scripts Bash: automatiza tu propia vida» · Apoyo: «6. Proyecto: pone tu PC a trabajar sola»
...
## 📦 Entregables
- [ ] Código en `proyectos/linux-y-terminal-el-superpoder-del-dev/proyecto-05/`
