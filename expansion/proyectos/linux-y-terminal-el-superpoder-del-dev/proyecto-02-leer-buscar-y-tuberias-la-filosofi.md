# 🚀 Proyecto 2: Leer, buscar y tuberías: la filosofía Unix

> 📚 Linux y Terminal — El Superpoder del Dev · Ancla: lección «2. Leer, buscar y tuberías: la filosofía Unix» · Apoyo: «3. Permisos y procesos: controlar el sistema»
...
## 📦 Entregables
- [ ] Código en `proyectos/linux-y-terminal-el-superpoder-del-dev/proyecto-02/`
