# 🚀 Proyecto 5: Amenazas en el código diario: XSS, CSRF y uploads

> 📚 Seguridad para Desarrolladores — No Seas la Brecha · Ancla: lección «4. Amenazas en el código diario: XSS, CSRF y uploads» · Apoyo: «5. Proyecto: auditoría de seguridad propia»
...
## 📦 Entregables
- [ ] Código en `proyectos/seguridad-para-desarrolladores-no-seas-la-brecha/proyecto-05/`
