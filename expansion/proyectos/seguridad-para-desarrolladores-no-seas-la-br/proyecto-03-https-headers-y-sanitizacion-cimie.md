# 🚀 Proyecto 3: HTTPS, headers y sanitización: cimientos prácticos

> 📚 Seguridad para Desarrolladores — No Seas la Brecha · Ancla: lección «2. HTTPS, headers y sanitización: cimientos prácticos» · Apoyo: «3. Autenticación moderna: sesiones, JWT y OAuth»
...
## 📦 Entregables
- [ ] Código en `proyectos/seguridad-para-desarrolladores-no-seas-la-brecha/proyecto-03/`
