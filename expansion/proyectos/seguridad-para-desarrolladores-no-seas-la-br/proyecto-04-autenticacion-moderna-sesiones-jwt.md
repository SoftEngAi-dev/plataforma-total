# 🚀 Proyecto 4: Autenticación moderna: sesiones, JWT y OAuth

> 📚 Seguridad para Desarrolladores — No Seas la Brecha · Ancla: lección «3. Autenticación moderna: sesiones, JWT y OAuth» · Apoyo: «4. Amenazas en el código diario: XSS, CSRF y uploads»
...
## 📦 Entregables
- [ ] Código en `proyectos/seguridad-para-desarrolladores-no-seas-la-brecha/proyecto-04/`
