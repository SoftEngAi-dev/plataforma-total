# 🚀 Proyecto 1: Los 5 pecados capitales (OWASP real)

> 📚 Seguridad para Desarrolladores — No Seas la Brecha · Ancla: lección «1. Los 5 pecados capitales (OWASP real)» · Apoyo: «2. HTTPS, headers y sanitización: cimientos prácticos»
...
## 📦 Entregables
- [ ] Código en `proyectos/seguridad-para-desarrolladores-no-seas-la-brecha/proyecto-01/`
