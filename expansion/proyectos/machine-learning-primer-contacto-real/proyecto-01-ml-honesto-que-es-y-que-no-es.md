# 🚀 Proyecto 1: ML honesto: qué es y qué NO es

> 📚 Machine Learning — Primer Contacto Real · Ancla: lección «1. ML honesto: qué es y qué NO es» · Apoyo: «2. Tu primer modelo: train/test y accuracy real»
...
## 📦 Entregables
- [ ] Código en `proyectos/machine-learning-primer-contacto-real/proyecto-01/`
