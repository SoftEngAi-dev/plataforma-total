# 🚀 Proyecto 5: Árboles de decisión y RandomForest: los caballos de batalla

> 📚 Machine Learning — Primer Contacto Real · Ancla: lección «4. Árboles de decisión y RandomForest: los caballos de batalla» · Apoyo: «5. Proyecto: pipeline completo de ML con datos reales»
...
## 📦 Entregables
- [ ] Código en `proyectos/machine-learning-primer-contacto-real/proyecto-05/`
