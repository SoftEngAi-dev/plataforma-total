# 🚀 Proyecto 6: Proyecto: pipeline completo de ML con datos reales

> 📚 Machine Learning — Primer Contacto Real · Ancla: lección «5. Proyecto: pipeline completo de ML con datos reales» · Apoyo: «1. ML honesto: qué es y qué NO es»
...
## 📦 Entregables
- [ ] Código en `proyectos/machine-learning-primer-contacto-real/proyecto-06/`
