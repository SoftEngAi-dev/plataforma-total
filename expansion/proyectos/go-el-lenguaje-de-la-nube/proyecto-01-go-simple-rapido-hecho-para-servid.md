# 🚀 Proyecto 1: Go: simple, rápido, hecho para servidores

> 📚 Go — El Lenguaje de la Nube · Ancla: lección «1. Go: simple, rápido, hecho para servidores» · Apoyo: «2. Errores a la vista: el if err != nil filosófico»
...
## 📦 Entregables
- [ ] Código en `proyectos/go-el-lenguaje-de-la-nube/proyecto-01/`
