# 🚀 Proyecto 3: Errores a la vista: el if err != nil filosófico

> 📚 Go — El Lenguaje de la Nube · Ancla: lección «2. Errores a la vista: el if err != nil filosófico» · Apoyo: «3. Concurrencia: goroutines y canales (el superpoder)»
...
## 📦 Entregables
- [ ] Código en `proyectos/go-el-lenguaje-de-la-nube/proyecto-03/`
