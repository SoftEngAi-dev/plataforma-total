# 🚀 Proyecto 5: Servidor HTTP estándar: la web sin frameworks

> 📚 Go — El Lenguaje de la Nube · Ancla: lección «4. Servidor HTTP estándar: la web sin frameworks» · Apoyo: «5. Proyecto: API Go real + binario listo para producción»
...
## 📦 Entregables
- [ ] Código en `proyectos/go-el-lenguaje-de-la-nube/proyecto-05/`
