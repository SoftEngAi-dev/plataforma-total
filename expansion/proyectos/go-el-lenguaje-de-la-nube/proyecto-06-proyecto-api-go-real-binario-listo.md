# 🚀 Proyecto 6: Proyecto: API Go real + binario listo para producción

> 📚 Go — El Lenguaje de la Nube · Ancla: lección «5. Proyecto: API Go real + binario listo para producción» · Apoyo: «1. Go: simple, rápido, hecho para servidores»
...
## 📦 Entregables
- [ ] Código en `proyectos/go-el-lenguaje-de-la-nube/proyecto-06/`
