# 🚀 Proyecto 4: Concurrencia: goroutines y canales (el superpoder)

> 📚 Go — El Lenguaje de la Nube · Ancla: lección «3. Concurrencia: goroutines y canales (el superpoder)» · Apoyo: «4. Servidor HTTP estándar: la web sin frameworks»
...
## 📦 Entregables
- [ ] Código en `proyectos/go-el-lenguaje-de-la-nube/proyecto-04/`
