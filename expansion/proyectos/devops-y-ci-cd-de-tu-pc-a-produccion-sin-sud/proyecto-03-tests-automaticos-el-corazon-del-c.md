# 🚀 Proyecto 3: Tests automáticos: el corazón del CI

> 📚 DevOps y CI/CD — De Tu PC a Producción Sin Sudor · Ancla: lección «3. Tests automáticos: el corazón del CI» · Apoyo: «4. Despliegue continuo y entornos»
...
## 📦 Entregables
- [ ] Código en `proyectos/devops-y-ci-cd-de-tu-pc-a-produccion-sin-sudor/proyecto-03/`
