# 🚀 Proyecto 6: Proyecto: pipeline CI/CD real para tu app

> 📚 DevOps y CI/CD — De Tu PC a Producción Sin Sudor · Ancla: lección «6. Proyecto: pipeline CI/CD real para tu app» · Apoyo: «1. DevOps en una frase y el pipeline»
...
## 📦 Entregables
- [ ] Código en `proyectos/devops-y-ci-cd-de-tu-pc-a-produccion-sin-sudor/proyecto-06/`
