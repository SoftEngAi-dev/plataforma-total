# 🚀 Proyecto 1: DevOps en una frase y el pipeline

> 📚 DevOps y CI/CD — De Tu PC a Producción Sin Sudor · Ancla: lección «1. DevOps en una frase y el pipeline» · Apoyo: «2. GitHub Actions desde cero: tu primer workflow»
...
## 📦 Entregables
- [ ] Código en `proyectos/devops-y-ci-cd-de-tu-pc-a-produccion-sin-sudor/proyecto-01/`
