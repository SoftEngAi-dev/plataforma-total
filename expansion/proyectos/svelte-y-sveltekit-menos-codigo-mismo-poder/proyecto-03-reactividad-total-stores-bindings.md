# 🚀 Proyecto 3: Reactividad total: stores, bindings y formularios

> 📚 Svelte y SvelteKit — Menos Código, Mismo Poder · Ancla: lección «2. Reactividad total: stores, bindings y formularios» · Apoyo: «3. SvelteKit y proyecto: app completa con rutas»
...
## 📦 Entregables
- [ ] Código en `proyectos/svelte-y-sveltekit-menos-codigo-mismo-poder/proyecto-03/`
