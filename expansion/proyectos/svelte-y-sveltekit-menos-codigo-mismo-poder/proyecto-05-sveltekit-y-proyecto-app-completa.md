# 🚀 Proyecto 5: SvelteKit y proyecto: app completa con rutas

> 📚 Svelte y SvelteKit — Menos Código, Mismo Poder · Ancla: lección «3. SvelteKit y proyecto: app completa con rutas» · Apoyo: «1. Svelte: el compilador que no envía framework»
...
## 📦 Entregables
- [ ] Código en `proyectos/svelte-y-sveltekit-menos-codigo-mismo-poder/proyecto-05/`
