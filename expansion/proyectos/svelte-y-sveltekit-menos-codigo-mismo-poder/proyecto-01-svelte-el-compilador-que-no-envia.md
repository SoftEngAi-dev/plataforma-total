# 🚀 Proyecto 1: Svelte: el compilador que no envía framework

> 📚 Svelte y SvelteKit — Menos Código, Mismo Poder · Ancla: lección «1. Svelte: el compilador que no envía framework» · Apoyo: «2. Reactividad total: stores, bindings y formularios»
...
## 📦 Entregables
- [ ] Código en `proyectos/svelte-y-sveltekit-menos-codigo-mismo-poder/proyecto-01/`
