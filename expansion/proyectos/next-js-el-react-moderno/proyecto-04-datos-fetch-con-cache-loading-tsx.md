# 🚀 Proyecto 4: Datos: fetch con caché, loading.tsx y error.tsx

> 📚 ▲ Next.js — El React Moderno · Ancla: lección «3. Datos: fetch con caché, loading.tsx y error.tsx» · Apoyo: «4. Server Actions: mutaciones sin escribir APIs»
...
## 📦 Entregables
- [ ] Código en `proyectos/next-js-el-react-moderno/proyecto-04/`
