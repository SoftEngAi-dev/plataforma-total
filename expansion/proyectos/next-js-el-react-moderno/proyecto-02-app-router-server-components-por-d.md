# 🚀 Proyecto 2: App Router: Server Components por defecto

> 📚 ▲ Next.js — El React Moderno · Ancla: lección «1. App Router: Server Components por defecto» · Apoyo: «2. 'use client': el borde servidor/navegador»
...
## 📦 Entregables
- [ ] Código en `proyectos/next-js-el-react-moderno/proyecto-02/`
