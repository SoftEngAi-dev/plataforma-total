# 🚀 Proyecto 3: 'use client': el borde servidor/navegador

> 📚 ▲ Next.js — El React Moderno · Ancla: lección «2. 'use client': el borde servidor/navegador» · Apoyo: «3. Datos: fetch con caché, loading.tsx y error.tsx»
...
## 📦 Entregables
- [ ] Código en `proyectos/next-js-el-react-moderno/proyecto-03/`
