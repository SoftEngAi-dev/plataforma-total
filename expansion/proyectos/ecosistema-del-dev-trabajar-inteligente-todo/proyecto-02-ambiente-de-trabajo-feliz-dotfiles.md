# 🚀 Proyecto 2: Ambiente de trabajo feliz: dotfiles, alias y costumbres

> 📚 Ecosistema del Dev — Trabajar Inteligente Todos los Días · Ancla: lección «1. Ambiente de trabajo feliz: dotfiles, alias y costumbres» · Apoyo: «2. Markdown + documentación que La gente lee»
...
## 📦 Entregables
- [ ] Código en `proyectos/ecosistema-del-dev-trabajar-inteligente-todos-los-dias/proyecto-02/`
