# 🚀 Proyecto 6: IA + automatización: trabaja menos chatos tú

> 📚 Ecosistema del Dev — Trabajar Inteligente Todos los Días · Ancla: lección «4. IA + automatización: trabaja menos chatos tú» · Apoyo: «1. Ambiente de trabajo feliz: dotfiles, alias y costumbres»
...
## 📦 Entregables
- [ ] Código en `proyectos/ecosistema-del-dev-trabajar-inteligente-todos-los-dias/proyecto-06/`
