# 🚀 Proyecto 4: Result y Option: errores como parte del tipo

> 📚 Rust — Velocidad de C sin Miedo a los Crashes · Ancla: lección «3. Result y Option: errores como parte del tipo» · Apoyo: «4. Structs, traits e iteradores: Rust en su salsa»
...
## 📦 Entregables
- [ ] Código en `proyectos/rust-velocidad-de-c-sin-miedo-a-los-crashes/proyecto-04/`
