# 🚀 Proyecto 6: Proyecto: CLI real en Rust con clap

> 📚 Rust — Velocidad de C sin Miedo a los Crashes · Ancla: lección «5. Proyecto: CLI real en Rust con clap» · Apoyo: «1. Rust: el lenguaje querido 9 años seguidos»
...
## 📦 Entregables
- [ ] Código en `proyectos/rust-velocidad-de-c-sin-miedo-a-los-crashes/proyecto-06/`
