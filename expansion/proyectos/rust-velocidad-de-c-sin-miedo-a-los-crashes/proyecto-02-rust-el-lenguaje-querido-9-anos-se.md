# 🚀 Proyecto 2: Rust: el lenguaje querido 9 años seguidos

> 📚 Rust — Velocidad de C sin Miedo a los Crashes · Ancla: lección «1. Rust: el lenguaje querido 9 años seguidos» · Apoyo: «2. Ownership: el sistema que cambia tu cabeza»
...
## 📦 Entregables
- [ ] Código en `proyectos/rust-velocidad-de-c-sin-miedo-a-los-crashes/proyecto-02/`
