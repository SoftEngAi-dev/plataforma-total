# 🚀 Proyecto 1: Java: el gigante tipado (fundamentos en 15 min)

> 📚 Java y Spring — El Backend del Mundo Empresarial · Ancla: lección «1. Java: el gigante tipado (fundamentos en 15 min)» · Apoyo: «2. Java moderno: records, streams y switch nuevo»
...
## 📦 Entregables
- [ ] Código en `proyectos/java-y-spring-el-backend-del-mundo-empresarial/proyecto-01/`
