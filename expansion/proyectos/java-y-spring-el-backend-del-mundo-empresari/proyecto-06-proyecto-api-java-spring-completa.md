# 🚀 Proyecto 6: Proyecto: API Java/Spring completa

> 📚 Java y Spring — El Backend del Mundo Empresarial · Ancla: lección «5. Proyecto: API Java/Spring completa» · Apoyo: «1. Java: el gigante tipado (fundamentos en 15 min)»
...
## 📦 Entregables
- [ ] Código en `proyectos/java-y-spring-el-backend-del-mundo-empresarial/proyecto-06/`
