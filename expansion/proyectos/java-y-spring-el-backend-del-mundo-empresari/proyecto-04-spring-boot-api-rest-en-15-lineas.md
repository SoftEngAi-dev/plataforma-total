# 🚀 Proyecto 4: Spring Boot: API REST en 15 líneas de verdad

> 📚 Java y Spring — El Backend del Mundo Empresarial · Ancla: lección «3. Spring Boot: API REST en 15 líneas de verdad» · Apoyo: «4. Spring Data JPA: base de datos casi gratis»
...
## 📦 Entregables
- [ ] Código en `proyectos/java-y-spring-el-backend-del-mundo-empresarial/proyecto-04/`
