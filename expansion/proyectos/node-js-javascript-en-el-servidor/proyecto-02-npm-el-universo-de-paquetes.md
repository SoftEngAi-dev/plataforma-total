# 🚀 Proyecto 2: npm: el universo de paquetes

> 📚 Node.js — JavaScript en el Servidor · Ancla: lección «2. npm: el universo de paquetes» · Apoyo: «3. Express: el servidor web minimalista»
...
## 📦 Entregables
- [ ] Código en `proyectos/node-js-javascript-en-el-servidor/proyecto-02/`
