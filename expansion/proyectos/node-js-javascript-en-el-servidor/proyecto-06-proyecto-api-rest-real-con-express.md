# 🚀 Proyecto 6: Proyecto: API REST real con Express

> 📚 Node.js — JavaScript en el Servidor · Ancla: lección «6. Proyecto: API REST real con Express» · Apoyo: «1. Node: sacar JS del navegador»
...
## 📦 Entregables
- [ ] Código en `proyectos/node-js-javascript-en-el-servidor/proyecto-06/`
