# 🚀 Proyecto 3: Express: el servidor web minimalista

> 📚 Node.js — JavaScript en el Servidor · Ancla: lección «3. Express: el servidor web minimalista» · Apoyo: «4. Asincronía en Node: no congeles el servidor»
...
## 📦 Entregables
- [ ] Código en `proyectos/node-js-javascript-en-el-servidor/proyecto-03/`
