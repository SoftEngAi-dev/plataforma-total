# 🚀 Proyecto 1: Node: sacar JS del navegador

> 📚 Node.js — JavaScript en el Servidor · Ancla: lección «1. Node: sacar JS del navegador» · Apoyo: «2. npm: el universo de paquetes»
...
## 📦 Entregables
- [ ] Código en `proyectos/node-js-javascript-en-el-servidor/proyecto-01/`
