# 🚀 Proyecto 4: Entity Framework Core: la BD como objetos C#

> 📚 C# y .NET — El Ecosistema Microsoft Moderno · Ancla: lección «3. Entity Framework Core: la BD como objetos C#» · Apoyo: «4. Proyecto: API .NET completa con EF Core»
...
## 📦 Entregables
- [ ] Código en `proyectos/c-y-net-el-ecosistema-microsoft-moderno/proyecto-04/`
