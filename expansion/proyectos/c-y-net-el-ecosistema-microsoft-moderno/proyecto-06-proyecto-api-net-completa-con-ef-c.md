# 🚀 Proyecto 6: Proyecto: API .NET completa con EF Core

> 📚 C# y .NET — El Ecosistema Microsoft Moderno · Ancla: lección «4. Proyecto: API .NET completa con EF Core» · Apoyo: «1. C#: lenguaje que ya no es 'de Windows'»
...
## 📦 Entregables
- [ ] Código en `proyectos/c-y-net-el-ecosistema-microsoft-moderno/proyecto-06/`
