# 🚀 Proyecto 2: C#: lenguaje que ya no es 'de Windows'

> 📚 C# y .NET — El Ecosistema Microsoft Moderno · Ancla: lección «1. C#: lenguaje que ya no es 'de Windows'» · Apoyo: «2. ASP.NET Minimal API: el Express de .NET»
...
## 📦 Entregables
- [ ] Código en `proyectos/c-y-net-el-ecosistema-microsoft-moderno/proyecto-02/`
