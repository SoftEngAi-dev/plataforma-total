# 🚀 Proyecto 3: ASP.NET Minimal API: el Express de .NET

> 📚 C# y .NET — El Ecosistema Microsoft Moderno · Ancla: lección «2. ASP.NET Minimal API: el Express de .NET» · Apoyo: «3. Entity Framework Core: la BD como objetos C#»
...
## 📦 Entregables
- [ ] Código en `proyectos/c-y-net-el-ecosistema-microsoft-moderno/proyecto-03/`
