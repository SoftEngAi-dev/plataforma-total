# 🚀 Proyecto 3: Deshacer: checkout, restore, revert, reset (la tabla salvadora)

> 📚 Git y GitHub — Tu Historia Nunca Se Pierde · Ancla: lección «3. Deshacer: checkout, restore, revert, reset (la tabla salvadora)» · Apoyo: «4. GitHub colaboración real: PRs y forks»
...
## 📦 Entregables
- [ ] Código en `proyectos/git-y-github-tu-historia-nunca-se-pierde/proyecto-03/`
