# 🚀 Proyecto 2: Ramas: el multiverso de tu proyecto

> 📚 Git y GitHub — Tu Historia Nunca Se Pierde · Ancla: lección «2. Ramas: el multiverso de tu proyecto» · Apoyo: «3. Deshacer: checkout, restore, revert, reset (la tabla salvadora)»
...
## 📦 Entregables
- [ ] Código en `proyectos/git-y-github-tu-historia-nunca-se-pierde/proyecto-02/`
