# 🚀 Proyecto 4: ActiveRecord: tu base de datos con sabor Ruby

> 📚 Ruby on Rails — La Felicidad del Desarrollador · Ancla: lección «3. ActiveRecord: tu base de datos con sabor Ruby» · Apoyo: «4. Vistas ERB, rutas y el ciclo de Rails»
...
## 📦 Entregables
- [ ] Código en `proyectos/ruby-on-rails-la-felicidad-del-desarrollador/proyecto-04/`
