# 🚀 Proyecto 1: Ruby: el lenguaje diseñado para ser feliz

> 📚 Ruby on Rails — La Felicidad del Desarrollador · Ancla: lección «1. Ruby: el lenguaje diseñado para ser feliz» · Apoyo: «2. Rails: convención sobre configuración»
...
## 📦 Entregables
- [ ] Código en `proyectos/ruby-on-rails-la-felicidad-del-desarrollador/proyecto-01/`
