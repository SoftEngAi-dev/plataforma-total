# 🚀 Proyecto 5: Vistas ERB, rutas y el ciclo de Rails

> 📚 Ruby on Rails — La Felicidad del Desarrollador · Ancla: lección «4. Vistas ERB, rutas y el ciclo de Rails» · Apoyo: «5. Proyecto: blog Rails con todo lo anterior»
...
## 📦 Entregables
- [ ] Código en `proyectos/ruby-on-rails-la-felicidad-del-desarrollador/proyecto-05/`
