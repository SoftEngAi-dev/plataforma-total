# 🚀 Proyecto 3: Instalar y gestionar paquetes (todo por terminal)

> 📚 Herramientas del Desarrollador · Ancla: lección «3. Instalar y gestionar paquetes (todo por terminal)» · Apoyo: «4. Git: la memoria eterna de tu código (básico)»
...
## 📦 Entregables
- [ ] Código en `proyectos/herramientas-del-desarrollador/proyecto-03/`
