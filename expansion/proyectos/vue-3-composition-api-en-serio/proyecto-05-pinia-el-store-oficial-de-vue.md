# 🚀 Proyecto 5: Pinia: el store oficial de Vue

> 📚 💚 Vue 3 — Composition API en Serio · Ancla: lección «4. Pinia: el store oficial de Vue» · Apoyo: «5. Nuxt 3: Vue full-stack»
...
## 📦 Entregables
- [ ] Código en `proyectos/vue-3-composition-api-en-serio/proyecto-05/`
