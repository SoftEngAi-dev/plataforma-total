# 🚀 Proyecto 1: El SFC y la reactividad con ref()

> 📚 💚 Vue 3 — Composition API en Serio · Ancla: lección «1. El SFC y la reactividad con ref()» · Apoyo: «2. computed, watch y las directivas esenciales»
...
## 📦 Entregables
- [ ] Código en `proyectos/vue-3-composition-api-en-serio/proyecto-01/`
