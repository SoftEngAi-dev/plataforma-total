# 🚀 Proyecto 4: C++: C más objetos y la STL (los superpoderes)

> 📚 C y C++ — Los Cimientos del Software Moderno · Ancla: lección «3. C++: C más objetos y la STL (los superpoderes)» · Apoyo: «4. Compilar y depurar: gcc, make y headers»
...
## 📦 Entregables
- [ ] Código en `proyectos/c-y-c-los-cimientos-del-software-moderno/proyecto-04/`
