# 🚀 Proyecto 3: Condicionales y verdad en Python

> 📚 Python — De Cero a Profesional · Ancla: lección «6. Condicionales y verdad en Python» · Apoyo: «7. Bucles: for, range, enumerate, while»
...
## 📦 Entregables
- [ ] Código en `proyectos/python-de-cero-a-profesional/proyecto-03/`
