# 🚀 Proyecto 1: Bases de datos y SQL: el lenguaje de los datos

> 📚 SQL y Bases de Datos — Datos que Persisten · Ancla: lección «1. Bases de datos y SQL: el lenguaje de los datos» · Apoyo: «2. SELECT con WHERE: filtrar con precisión»
...
## 📦 Entregables
- [ ] Código en `proyectos/sql-y-bases-de-datos-datos-que-persisten/proyecto-01/`
