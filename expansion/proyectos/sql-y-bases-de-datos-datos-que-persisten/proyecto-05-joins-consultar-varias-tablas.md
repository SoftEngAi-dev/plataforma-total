# 🚀 Proyecto 5: JOINs: consultar varias tablas

> 📚 SQL y Bases de Datos — Datos que Persisten · Ancla: lección «7. JOINs: consultar varias tablas» · Apoyo: «8. Índices y transacciones: velocidad y seguridad»
...
## 📦 Entregables
- [ ] Código en `proyectos/sql-y-bases-de-datos-datos-que-persisten/proyecto-05/`
