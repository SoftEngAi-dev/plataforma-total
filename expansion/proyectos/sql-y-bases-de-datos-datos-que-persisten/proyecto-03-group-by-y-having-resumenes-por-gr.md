# 🚀 Proyecto 3: GROUP BY y HAVING: resúmenes por grupos

> 📚 SQL y Bases de Datos — Datos que Persisten · Ancla: lección «4. GROUP BY y HAVING: resúmenes por grupos» · Apoyo: «5. CREATE, INSERT, UPDATE, DELETE: escribir datos»
...
## 📦 Entregables
- [ ] Código en `proyectos/sql-y-bases-de-datos-datos-que-persisten/proyecto-03/`
