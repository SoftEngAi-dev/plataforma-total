# 🚀 Proyecto 2: SELECT con WHERE: filtrar con precisión

> 📚 SQL y Bases de Datos — Datos que Persisten · Ancla: lección «2. SELECT con WHERE: filtrar con precisión» · Apoyo: «3. Ordenar, limitar y funciones agregadas»
...
## 📦 Entregables
- [ ] Código en `proyectos/sql-y-bases-de-datos-datos-que-persisten/proyecto-02/`
