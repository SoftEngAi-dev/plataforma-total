# 🚀 Proyecto 3: Capturar grupos y.los casos reales: validación y extracción

> 📚 Expresiones Regulares — El Lenguaje de Patrones · Ancla: lección «2. Capturar grupos y.los casos reales: validación y extracción» · Apoyo: «3. Los 5 errores clásicos de regex (no sufras estos)»
...
## 📦 Entregables
- [ ] Código en `proyectos/expresiones-regulares-el-lenguaje-de-patrones/proyecto-03/`
