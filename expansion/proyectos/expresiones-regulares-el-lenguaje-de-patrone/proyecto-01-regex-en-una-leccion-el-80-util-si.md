# 🚀 Proyecto 1: Regex en una lección: el 80% útil sin dolor

> 📚 Expresiones Regulares — El Lenguaje de Patrones · Ancla: lección «1. Regex en una lección: el 80% útil sin dolor» · Apoyo: «2. Capturar grupos y.los casos reales: validación y extracción»
...
## 📦 Entregables
- [ ] Código en `proyectos/expresiones-regulares-el-lenguaje-de-patrones/proyecto-01/`
