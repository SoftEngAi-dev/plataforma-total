# 🚀 Proyecto 6: Proyecto guiado: tu página personal completa

> 📚 HTML y CSS — Diseño Web Total · Ancla: lección «9. Proyecto guiado: tu página personal completa» · Apoyo: «10. Accesibilidad básica: la web es para todas las personas»
...
## 📦 Entregables
- [ ] Código en `proyectos/html-y-css-diseno-web-total/proyecto-06/`
