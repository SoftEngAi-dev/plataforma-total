# 🚀 Proyecto 4: TextInput, estado y persistencia (AsyncStorage)

> 📚 React Native — Móvil con Tu Stack Web · Ancla: lección «3. TextInput, estado y persistencia (AsyncStorage)» · Apoyo: «4. Proyecto: app móvil completa con Expo»
...
## 📦 Entregables
- [ ] Código en `proyectos/react-native-movil-con-tu-stack-web/proyecto-04/`
