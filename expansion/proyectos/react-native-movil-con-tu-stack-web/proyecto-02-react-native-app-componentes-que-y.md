# 🚀 Proyecto 2: React Native: App = componentes que ya sabes

> 📚 React Native — Móvil con Tu Stack Web · Ancla: lección «1. React Native: App = componentes que ya sabes» · Apoyo: «2. listas, estilos y navegación móvil»
...
## 📦 Entregables
- [ ] Código en `proyectos/react-native-movil-con-tu-stack-web/proyecto-02/`
