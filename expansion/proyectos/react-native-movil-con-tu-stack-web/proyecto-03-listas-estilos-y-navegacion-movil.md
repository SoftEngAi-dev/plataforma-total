# 🚀 Proyecto 3: listas, estilos y navegación móvil

> 📚 React Native — Móvil con Tu Stack Web · Ancla: lección «2. listas, estilos y navegación móvil» · Apoyo: «3. TextInput, estado y persistencia (AsyncStorage)»
...
## 📦 Entregables
- [ ] Código en `proyectos/react-native-movil-con-tu-stack-web/proyecto-03/`
