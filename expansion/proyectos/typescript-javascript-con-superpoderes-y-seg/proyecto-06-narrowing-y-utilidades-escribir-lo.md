# 🚀 Proyecto 6: Narrowing y utilidades: escribir lógica segura

> 📚 TypeScript — JavaScript con Superpoderes y Seguridad · Ancla: lección «6. Narrowing y utilidades: escribir lógica segura» · Apoyo: «7. TS en proyectos reales: configuración y flujo»
...
## 📦 Entregables
- [ ] Código en `proyectos/typescript-javascript-con-superpoderes-y-seguridad/proyecto-06/`
