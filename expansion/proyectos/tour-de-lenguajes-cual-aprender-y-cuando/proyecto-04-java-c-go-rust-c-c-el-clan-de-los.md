# 🚀 Proyecto 4: Java, C#, Go, Rust, C/C++: el clan de los compilados

> 📚 Tour de Lenguajes — Cuál Aprender y Cuándo · Ancla: lección «3. Java, C#, Go, Rust, C/C++: el clan de los compilados» · Apoyo: «4. Kotlin, Swift, Dart/Flutter, React Native: el mapa móvil»
...
## 📦 Entregables
- [ ] Código en `proyectos/tour-de-lenguajes-cual-aprender-y-cuando/proyecto-04/`
