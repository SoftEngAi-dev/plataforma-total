# 🚀 Proyecto 3: SvelteKit: rutas +page y datos con load

> 📚 🔥 SvelteKit & Svelte 5 — Apps Completas · Ancla: lección «2. SvelteKit: rutas +page y datos con load» · Apoyo: «3. Form actions: el regreso glorioso del <form>»
...
## 📦 Entregables
- [ ] Código en `proyectos/sveltekit-svelte-5-apps-completas/proyecto-03/`
