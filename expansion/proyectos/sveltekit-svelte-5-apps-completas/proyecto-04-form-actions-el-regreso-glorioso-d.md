# 🚀 Proyecto 4: Form actions: el regreso glorioso del <form>

> 📚 🔥 SvelteKit & Svelte 5 — Apps Completas · Ancla: lección «3. Form actions: el regreso glorioso del <form>» · Apoyo: «4. Endpoints +server.js, adapters y despliegue»
...
## 📦 Entregables
- [ ] Código en `proyectos/sveltekit-svelte-5-apps-completas/proyecto-04/`
