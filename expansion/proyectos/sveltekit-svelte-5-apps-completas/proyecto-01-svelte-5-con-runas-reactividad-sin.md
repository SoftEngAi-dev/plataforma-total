# 🚀 Proyecto 1: Svelte 5 con runas: reactividad sin Virtual DOM

> 📚 🔥 SvelteKit & Svelte 5 — Apps Completas · Ancla: lección «1. Svelte 5 con runas: reactividad sin Virtual DOM» · Apoyo: «2. SvelteKit: rutas +page y datos con load»
...
## 📦 Entregables
- [ ] Código en `proyectos/sveltekit-svelte-5-apps-completas/proyecto-01/`
