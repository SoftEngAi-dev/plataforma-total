# 🚀 Proyecto 6: Endpoints +server.js, adapters y despliegue

> 📚 🔥 SvelteKit & Svelte 5 — Apps Completas · Ancla: lección «4. Endpoints +server.js, adapters y despliegue» · Apoyo: «1. Svelte 5 con runas: reactividad sin Virtual DOM»
...
## 📦 Entregables
- [ ] Código en `proyectos/sveltekit-svelte-5-apps-completas/proyecto-06/`
