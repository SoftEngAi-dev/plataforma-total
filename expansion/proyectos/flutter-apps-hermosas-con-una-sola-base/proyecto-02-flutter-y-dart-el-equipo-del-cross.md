# 🚀 Proyecto 2: Flutter y Dart: el equipo del cross-platform

> 📚 Flutter — Apps Hermosas con Una Sola Base · Ancla: lección «1. Flutter y Dart: el equipo del cross-platform» · Apoyo: «2. Widgets: TODO es un widget»
...
## 📦 Entregables
- [ ] Código en `proyectos/flutter-apps-hermosas-con-una-sola-base/proyecto-02/`
