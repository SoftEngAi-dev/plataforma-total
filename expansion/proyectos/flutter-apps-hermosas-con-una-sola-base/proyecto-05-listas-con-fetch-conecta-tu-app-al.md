# 🚀 Proyecto 5: Listas con fetch: conecta tu app al mundo

> 📚 Flutter — Apps Hermosas con Una Sola Base · Ancla: lección «4. Listas con fetch: conecta tu app al mundo» · Apoyo: «5. Proyecto: app Flutter completa»
...
## 📦 Entregables
- [ ] Código en `proyectos/flutter-apps-hermosas-con-una-sola-base/proyecto-05/`
