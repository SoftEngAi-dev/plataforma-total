# 🚀 Proyecto 3: Widgets: TODO es un widget

> 📚 Flutter — Apps Hermosas con Una Sola Base · Ancla: lección «2. Widgets: TODO es un widget» · Apoyo: «3. Estado con StatefulWidget y setState»
...
## 📦 Entregables
- [ ] Código en `proyectos/flutter-apps-hermosas-con-una-sola-base/proyecto-03/`
