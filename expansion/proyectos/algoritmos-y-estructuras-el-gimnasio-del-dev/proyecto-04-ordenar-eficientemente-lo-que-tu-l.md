# 🚀 Proyecto 4: Ordenar eficientemente: lo que tu lenguaje hace por ti

> 📚 Algoritmos y Estructuras — El Gimnasio del Dev · Ancla: lección «3. Ordenar eficientemente: lo que tu lenguaje hace por ti» · Apoyo: «4. Estructuras: pilas, colas y el cuándo elegirlas»
...
## 📦 Entregables
- [ ] Código en `proyectos/algoritmos-y-estructuras-el-gimnasio-del-dev/proyecto-04/`
