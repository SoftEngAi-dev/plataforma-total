# 🚀 Proyecto 2: Big O: el idioma de la eficiencia

> 📚 Algoritmos y Estructuras — El Gimnasio del Dev · Ancla: lección «1. Big O: el idioma de la eficiencia» · Apoyo: «2. Buscar: lineal vs binaria + el hash map»
...
## 📦 Entregables
- [ ] Código en `proyectos/algoritmos-y-estructuras-el-gimnasio-del-dev/proyecto-02/`
