# 🚀 Proyecto 1: Por qué existen: más allá de Node

> 📚 🍞 Bun & Deno — Los Nuevos Runtimes · Ancla: lección «1. Por qué existen: más allá de Node» · Apoyo: «2. Bun en la práctica»
...
## 📦 Entregables
- [ ] Código en `proyectos/bun-deno-los-nuevos-runtimes/proyecto-01/`
