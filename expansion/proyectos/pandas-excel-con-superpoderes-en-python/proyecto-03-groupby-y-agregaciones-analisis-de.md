# 🚀 Proyecto 3: groupby y agregaciones: análisis de negocio directo

> 📚 Pandas — Excel con Superpoderes en Python · Ancla: lección «3. groupby y agregaciones: análisis de negocio directo» · Apoyo: «4. Fechas, strings y aplicaciones avanzadas (los .dt/.str)»
...
## 📦 Entregables
- [ ] Código en `proyectos/pandas-excel-con-superpoderes-en-python/proyecto-03/`
