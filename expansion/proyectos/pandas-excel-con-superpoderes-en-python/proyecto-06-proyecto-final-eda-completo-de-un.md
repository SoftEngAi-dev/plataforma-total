# 🚀 Proyecto 6: Proyecto final: EDA completo de un dataset público

> 📚 Pandas — Excel con Superpoderes en Python · Ancla: lección «6. Proyecto final: EDA completo de un dataset público» · Apoyo: «1. DataFrames: tablero mental de pandas»
...
## 📦 Entregables
- [ ] Código en `proyectos/pandas-excel-con-superpoderes-en-python/proyecto-06/`
