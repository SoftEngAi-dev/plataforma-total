# 🚀 Proyecto 2: CSV, limpieza y transformación de columnas

> 📚 Pandas — Excel con Superpoderes en Python · Ancla: lección «2. CSV, limpieza y transformación de columnas» · Apoyo: «3. groupby y agregaciones: análisis de negocio directo»
...
## 📦 Entregables
- [ ] Código en `proyectos/pandas-excel-con-superpoderes-en-python/proyecto-02/`
