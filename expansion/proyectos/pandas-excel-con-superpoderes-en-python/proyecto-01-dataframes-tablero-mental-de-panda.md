# 🚀 Proyecto 1: DataFrames: tablero mental de pandas

> 📚 Pandas — Excel con Superpoderes en Python · Ancla: lección «1. DataFrames: tablero mental de pandas» · Apoyo: «2. CSV, limpieza y transformación de columnas»
...
## 📦 Entregables
- [ ] Código en `proyectos/pandas-excel-con-superpoderes-en-python/proyecto-01/`
