# 🚀 Proyecto 5: Visualización rápida y detección de historias

> 📚 Pandas — Excel con Superpoderes en Python · Ancla: lección «5. Visualización rápida y detección de historias» · Apoyo: «6. Proyecto final: EDA completo de un dataset público»
...
## 📦 Entregables
- [ ] Código en `proyectos/pandas-excel-con-superpoderes-en-python/proyecto-05/`
