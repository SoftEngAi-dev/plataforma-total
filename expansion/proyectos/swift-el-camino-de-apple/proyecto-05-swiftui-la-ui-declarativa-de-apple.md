# 🚀 Proyecto 5: SwiftUI: la UI declarativa de Apple

> 📚 Swift — El Camino de Apple · Ancla: lección «4. SwiftUI: la UI declarativa de Apple» · Apoyo: «5. Proyecto: tu primera app iOS real»
...
## 📦 Entregables
- [ ] Código en `proyectos/swift-el-camino-de-apple/proyecto-05/`
