# 🚀 Proyecto 2: Cómo estudiar una lección (método comprobado)

> 📚 Ruta Maestra — Cómo Usar Esta Plataforma · Ancla: lección «2. Cómo estudiar una lección (método comprobado)» · Apoyo: «3. Tus herramientas: progreso, racha y certificados»
...
## 📦 Entregables
- [ ] Código en `proyectos/ruta-maestra-como-usar-esta-plataforma/proyecto-02/`
