# 🚀 Proyecto 1: Docker: qué es y por qué lo necesitas

> 📚 Docker — 'En Mi Máquina Sí Funciona' Resuelto · Ancla: lección «1. Docker: qué es y por qué lo necesitas» · Apoyo: «2. Imágenes: descargar y listar»
...
## 📦 Entregables
- [ ] Código en `proyectos/docker-en-mi-maquina-si-funciona-resuelto/proyecto-01/`
