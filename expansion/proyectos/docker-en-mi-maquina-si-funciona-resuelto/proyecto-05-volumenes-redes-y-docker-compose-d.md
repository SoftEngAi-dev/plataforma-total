# 🚀 Proyecto 5: Volúmenes, redes y docker-compose: demasiado para la vida real

> 📚 Docker — 'En Mi Máquina Sí Funciona' Resuelto · Ancla: lección «4. Volúmenes, redes y docker-compose: demasiado para la vida real» · Apoyo: «5. Proyecto: dockeriza tu app + publica»
...
## 📦 Entregables
- [ ] Código en `proyectos/docker-en-mi-maquina-si-funciona-resuelto/proyecto-05/`
