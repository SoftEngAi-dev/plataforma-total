# 🚀 Proyecto 6: Proyecto: dockeriza tu app + publica

> 📚 Docker — 'En Mi Máquina Sí Funciona' Resuelto · Ancla: lección «5. Proyecto: dockeriza tu app + publica» · Apoyo: «1. Docker: qué es y por qué lo necesitas»
...
## 📦 Entregables
- [ ] Código en `proyectos/docker-en-mi-maquina-si-funciona-resuelto/proyecto-06/`
