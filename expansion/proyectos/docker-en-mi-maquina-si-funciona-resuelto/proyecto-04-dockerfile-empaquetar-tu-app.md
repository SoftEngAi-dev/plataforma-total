# 🚀 Proyecto 4: Dockerfile: empaquetar TU app

> 📚 Docker — 'En Mi Máquina Sí Funciona' Resuelto · Ancla: lección «3. Dockerfile: empaquetar TU app» · Apoyo: «4. Volúmenes, redes y docker-compose: demasiado para la vida real»
...
## 📦 Entregables
- [ ] Código en `proyectos/docker-en-mi-maquina-si-funciona-resuelto/proyecto-04/`
