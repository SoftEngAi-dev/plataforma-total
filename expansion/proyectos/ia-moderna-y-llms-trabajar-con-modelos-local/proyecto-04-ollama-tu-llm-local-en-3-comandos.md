# 🚀 Proyecto 4: Ollama: tu LLM local en 3 comandos

> 📚 IA Moderna y LLMs — Trabajar con Modelos Locales · Ancla: lección «3. Ollama: tu LLM local en 3 comandos» · Apoyo: «4. Proyecto: integra IA local en TU app»
...
## 📦 Entregables
- [ ] Código en `proyectos/ia-moderna-y-llms-trabajar-con-modelos-locales/proyecto-04/`
