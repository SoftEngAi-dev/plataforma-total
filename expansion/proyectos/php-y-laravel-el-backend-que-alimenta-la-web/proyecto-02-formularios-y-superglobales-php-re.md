# 🚀 Proyecto 2: Formularios y superglobales: PHP recibe datos

> 📚 PHP y Laravel — El Backend Que Alimenta la Web · Ancla: lección «2. Formularios y superglobales: PHP recibe datos» · Apoyo: «3. PDO: bases de datos sin inyección»
...
## 📦 Entregables
- [ ] Código en `proyectos/php-y-laravel-el-backend-que-alimenta-la-web/proyecto-02/`
