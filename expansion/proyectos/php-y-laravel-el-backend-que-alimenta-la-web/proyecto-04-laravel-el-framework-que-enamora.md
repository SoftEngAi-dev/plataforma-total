# 🚀 Proyecto 4: Laravel: el framework que enamora

> 📚 PHP y Laravel — El Backend Que Alimenta la Web · Ancla: lección «4. Laravel: el framework que enamora» · Apoyo: «5. MVC en Laravel: flujo completo de una petición»
...
## 📦 Entregables
- [ ] Código en `proyectos/php-y-laravel-el-backend-que-alimenta-la-web/proyecto-04/`
