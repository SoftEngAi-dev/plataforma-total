# 🚀 Proyecto 6: Proyecto: CRUD completo en Laravel

> 📚 PHP y Laravel — El Backend Que Alimenta la Web · Ancla: lección «6. Proyecto: CRUD completo en Laravel» · Apoyo: «1. PHP: el gigante subestimado»
...
## 📦 Entregables
- [ ] Código en `proyectos/php-y-laravel-el-backend-que-alimenta-la-web/proyecto-06/`
