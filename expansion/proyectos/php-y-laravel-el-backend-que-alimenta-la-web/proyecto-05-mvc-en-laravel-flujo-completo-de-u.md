# 🚀 Proyecto 5: MVC en Laravel: flujo completo de una petición

> 📚 PHP y Laravel — El Backend Que Alimenta la Web · Ancla: lección «5. MVC en Laravel: flujo completo de una petición» · Apoyo: «6. Proyecto: CRUD completo en Laravel»
...
## 📦 Entregables
- [ ] Código en `proyectos/php-y-laravel-el-backend-que-alimenta-la-web/proyecto-05/`
