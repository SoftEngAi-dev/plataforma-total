# 🚀 Proyecto 1: PHP: el gigante subestimado

> 📚 PHP y Laravel — El Backend Que Alimenta la Web · Ancla: lección «1. PHP: el gigante subestimado» · Apoyo: «2. Formularios y superglobales: PHP recibe datos»
...
## 📦 Entregables
- [ ] Código en `proyectos/php-y-laravel-el-backend-que-alimenta-la-web/proyecto-01/`
