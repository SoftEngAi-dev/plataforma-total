# 🚀 Proyecto 3: PDO: bases de datos sin inyección

> 📚 PHP y Laravel — El Backend Que Alimenta la Web · Ancla: lección «3. PDO: bases de datos sin inyección» · Apoyo: «4. Laravel: el framework que enamora»
...
## 📦 Entregables
- [ ] Código en `proyectos/php-y-laravel-el-backend-que-alimenta-la-web/proyecto-03/`
