# 🚀 Proyecto 6: Proyecto: tu primer análisis R real

> 📚 R y Estadística — El Idioma de los Datos · Ancla: lección «4. Proyecto: tu primer análisis R real» · Apoyo: «1. R en 15 minutos: vectores, el corazón»
...
## 📦 Entregables
- [ ] Código en `proyectos/r-y-estadistica-el-idioma-de-los-datos/proyecto-06/`
