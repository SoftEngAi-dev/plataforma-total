# 🛠 Ejercicio práctico — 4. Git: la memoria eterna de tu código (básico)

> 📚 Herramientas del Desarrollador · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Git: la memoria eterna de tu código (básico)** — sin copiar y pegar de la lección.
...
# Tema: 4. Git: la memoria eterna de tu código (básico)
```
