# 🛠 Ejercicio práctico — 1. El editor de código: tu casa de trabajo

> 📚 Herramientas del Desarrollador · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**El editor de código: tu casa de trabajo** — sin copiar y pegar de la lección.
...
# Tema: 1. El editor de código: tu casa de trabajo
```
