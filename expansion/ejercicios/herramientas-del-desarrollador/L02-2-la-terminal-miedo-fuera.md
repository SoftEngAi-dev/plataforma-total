# 🛠 Ejercicio práctico — 2. La terminal: miedo fuera

> 📚 Herramientas del Desarrollador · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**La terminal: miedo fuera** — sin copiar y pegar de la lección.
...
# Tema: 2. La terminal: miedo fuera
```
