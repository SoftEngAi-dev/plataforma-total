# 🛠 Ejercicio práctico — 3. Instalar y gestionar paquetes (todo por terminal)

> 📚 Herramientas del Desarrollador · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Instalar y gestionar paquetes (todo por terminal)** — sin copiar y pegar de la lección.
...
# Tema: 3. Instalar y gestionar paquetes (todo por terminal)
```
