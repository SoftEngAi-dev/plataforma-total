# 🛠 Ejercicio práctico — 9. Proyecto guiado: tu página personal completa

> 📚 HTML y CSS — Diseño Web Total · Lección 9 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto guiado: tu página personal completa** — sin copiar y pegar de la lección.
...
# Tema: 9. Proyecto guiado: tu página personal completa
```
