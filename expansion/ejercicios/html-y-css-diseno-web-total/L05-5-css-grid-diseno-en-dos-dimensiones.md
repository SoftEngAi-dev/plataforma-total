# 🛠 Ejercicio práctico — 5. CSS Grid: diseño en dos dimensiones

> 📚 HTML y CSS — Diseño Web Total · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**CSS Grid: diseño en dos dimensiones** — sin copiar y pegar de la lección.
...
# Tema: 5. CSS Grid: diseño en dos dimensiones
```
