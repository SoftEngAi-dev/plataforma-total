# 🛠 Ejercicio práctico — 6. Responsive design: una web para todos los tamaños

> 📚 HTML y CSS — Diseño Web Total · Lección 6 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Responsive design: una web para todos los tamaños** — sin copiar y pegar de la lección.
...
# Tema: 6. Responsive design: una web para todos los tamaños
```
