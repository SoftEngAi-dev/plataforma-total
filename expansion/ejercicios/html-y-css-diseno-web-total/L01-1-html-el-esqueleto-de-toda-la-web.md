# 🛠 Ejercicio práctico — 1. HTML: el esqueleto de toda la web

> 📚 HTML y CSS — Diseño Web Total · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**HTML: el esqueleto de toda la web** — sin copiar y pegar de la lección.
...
# Tema: 1. HTML: el esqueleto de toda la web
```
