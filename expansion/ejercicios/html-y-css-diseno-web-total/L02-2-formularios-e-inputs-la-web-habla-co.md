# 🛠 Ejercicio práctico — 2. Formularios e inputs: la web habla contigo

> 📚 HTML y CSS — Diseño Web Total · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Formularios e inputs: la web habla contigo** — sin copiar y pegar de la lección.
...
# Tema: 2. Formularios e inputs: la web habla contigo
```
