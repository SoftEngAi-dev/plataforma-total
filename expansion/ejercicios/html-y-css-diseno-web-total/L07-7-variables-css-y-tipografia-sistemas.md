# 🛠 Ejercicio práctico — 7. Variables CSS y tipografía: sistemas de diseño mínimos

> 📚 HTML y CSS — Diseño Web Total · Lección 7 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Variables CSS y tipografía: sistemas de diseño mínimos** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.html`) y escribe el código desde cero.
...
# Tema: 7. Variables CSS y tipografía: sistemas de diseño mínimos
```
