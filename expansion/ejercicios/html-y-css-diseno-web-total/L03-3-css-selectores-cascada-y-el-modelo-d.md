# 🛠 Ejercicio práctico — 3. CSS: selectores, cascada y el modelo de caja

> 📚 HTML y CSS — Diseño Web Total · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**CSS: selectores, cascada y el modelo de caja** — sin copiar y pegar de la lección.
...
# Tema: 3. CSS: selectores, cascada y el modelo de caja
```
