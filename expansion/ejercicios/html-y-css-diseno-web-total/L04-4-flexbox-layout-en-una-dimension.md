# 🛠 Ejercicio práctico — 4. Flexbox: layout en una dimensión

> 📚 HTML y CSS — Diseño Web Total · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Flexbox: layout en una dimensión** — sin copiar y pegar de la lección.
...
# Tema: 4. Flexbox: layout en una dimensión
```
