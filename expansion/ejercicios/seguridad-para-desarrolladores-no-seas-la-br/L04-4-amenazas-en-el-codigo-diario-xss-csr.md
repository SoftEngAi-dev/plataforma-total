# 🛠 Ejercicio práctico — 4. Amenazas en el código diario: XSS, CSRF y uploads

> 📚 Seguridad para Desarrolladores — No Seas la Brecha · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Amenazas en el código diario: XSS, CSRF y uploads** — sin copiar y pegar de la lección.
...
# Tema: 4. Amenazas en el código diario: XSS, CSRF y uploads
```
