# 🛠 Ejercicio práctico — 1. Los 5 pecados capitales (OWASP real)

> 📚 Seguridad para Desarrolladores — No Seas la Brecha · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Los 5 pecados capitales (OWASP real)** — sin copiar y pegar de la lección.
...
# Tema: 1. Los 5 pecados capitales (OWASP real)
```
