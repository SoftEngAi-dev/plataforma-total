# 🛠 Ejercicio práctico — 6. Narrowing y utilidades: escribir lógica segura

> 📚 TypeScript — JavaScript con Superpoderes y Seguridad · Lección 6 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Narrowing y utilidades: escribir lógica segura** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.js`) y escribe el código desde cero.
...
# Tema: 6. Narrowing y utilidades: escribir lógica segura
```
