# 🛠 Ejercicio práctico — 3. Interfaces vs Types: modelar el mundo

> 📚 TypeScript — JavaScript con Superpoderes y Seguridad · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Interfaces vs Types: modelar el mundo** — sin copiar y pegar de la lección.
...
# Tema: 3. Interfaces vs Types: modelar el mundo
```
