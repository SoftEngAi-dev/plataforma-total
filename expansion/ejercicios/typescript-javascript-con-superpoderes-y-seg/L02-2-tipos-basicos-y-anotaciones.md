# 🛠 Ejercicio práctico — 2. Tipos básicos y anotaciones

> 📚 TypeScript — JavaScript con Superpoderes y Seguridad · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Tipos básicos y anotaciones** — sin copiar y pegar de la lección.
...
# Tema: 2. Tipos básicos y anotaciones
```
