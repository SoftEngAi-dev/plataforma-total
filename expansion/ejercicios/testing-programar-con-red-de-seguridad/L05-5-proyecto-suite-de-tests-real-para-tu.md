# 🛠 Ejercicio práctico — 5. Proyecto: suite de tests real para tu calculadora/app

> 📚 Testing — Programar con Red de Seguridad · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: suite de tests real para tu calculadora/app** — sin copiar y pegar de la lección.
...
# Tema: 5. Proyecto: suite de tests real para tu calculadora/app
```
