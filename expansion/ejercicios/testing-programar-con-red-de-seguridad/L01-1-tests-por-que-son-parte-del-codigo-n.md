# 🛠 Ejercicio práctico — 1. Tests: por qué son parte del código, no un extra

> 📚 Testing — Programar con Red de Seguridad · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Tests: por qué son parte del código, no un extra** — sin copiar y pegar de la lección.
...
# Tema: 1. Tests: por qué son parte del código, no un extra
```
