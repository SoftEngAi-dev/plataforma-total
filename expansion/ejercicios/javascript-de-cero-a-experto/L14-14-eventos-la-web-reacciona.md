# 🛠 Ejercicio práctico — 14. Eventos: la web reacciona

> 📚 JavaScript — De Cero a Experto · Lección 14 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Eventos: la web reacciona** — sin copiar y pegar de la lección.
...
# Tema: 14. Eventos: la web reacciona
```
