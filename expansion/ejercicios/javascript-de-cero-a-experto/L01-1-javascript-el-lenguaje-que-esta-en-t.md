# 🛠 Ejercicio práctico — 1. JavaScript: el lenguaje que está en todas partes

> 📚 JavaScript — De Cero a Experto · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**JavaScript: el lenguaje que está en todas partes** — sin copiar y pegar de la lección.
...
# Tema: 1. JavaScript: el lenguaje que está en todas partes
```
