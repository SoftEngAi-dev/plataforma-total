# 🛠 Ejercicio práctico — 10. map, filter, reduce: programar sin bucles

> 📚 JavaScript — De Cero a Experto · Lección 10 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**map, filter, reduce: programar sin bucles** — sin copiar y pegar de la lección.
...
# Tema: 10. map, filter, reduce: programar sin bucles
```
