# 🛠 Ejercicio práctico — 15. Asincronía: setTimeout, promesas y async/await

> 📚 JavaScript — De Cero a Experto · Lección 15 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Asincronía: setTimeout, promesas y async/await** — sin copiar y pegar de la lección.
...
# Tema: 15. Asincronía: setTimeout, promesas y async/await
```
