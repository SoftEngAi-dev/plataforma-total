# 🛠 Ejercicio práctico — 3. Tipos de datos y operadores

> 📚 JavaScript — De Cero a Experto · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Tipos de datos y operadores** — sin copiar y pegar de la lección.
...
# Tema: 3. Tipos de datos y operadores
```
