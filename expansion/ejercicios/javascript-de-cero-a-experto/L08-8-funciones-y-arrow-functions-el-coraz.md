# 🛠 Ejercicio práctico — 8. Funciones y arrow functions: el corazón de JS

> 📚 JavaScript — De Cero a Experto · Lección 8 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Funciones y arrow functions: el corazón de JS** — sin copiar y pegar de la lección.
...
# Tema: 8. Funciones y arrow functions: el corazón de JS
```
