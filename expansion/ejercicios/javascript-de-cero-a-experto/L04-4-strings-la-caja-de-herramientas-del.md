# 🛠 Ejercicio práctico — 4. Strings: la caja de herramientas del texto

> 📚 JavaScript — De Cero a Experto · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Strings: la caja de herramientas del texto** — sin copiar y pegar de la lección.
...
# Tema: 4. Strings: la caja de herramientas del texto
```
