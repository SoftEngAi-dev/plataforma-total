# 🛠 Ejercicio práctico — 6. Condicionales: if, else y el operador ternario

> 📚 JavaScript — De Cero a Experto · Lección 6 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Condicionales: if, else y el operador ternario** — sin copiar y pegar de la lección.
...
# Tema: 6. Condicionales: if, else y el operador ternario
```
