# 🛠 Ejercicio práctico — 11. Objetos: diccionarios con superpoderes

> 📚 JavaScript — De Cero a Experto · Lección 11 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Objetos: diccionarios con superpoderes** — sin copiar y pegar de la lección.
...
# Tema: 11. Objetos: diccionarios con superpoderes
```
