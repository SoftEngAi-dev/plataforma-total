# 🛠 Ejercicio práctico — 9. Arrays: la colección reina

> 📚 JavaScript — De Cero a Experto · Lección 9 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Arrays: la colección reina** — sin copiar y pegar de la lección.
...
# Tema: 9. Arrays: la colección reina
```
