# 🛠 Ejercicio práctico — 16. fetch: hablar con APIs del mundo

> 📚 JavaScript — De Cero a Experto · Lección 16 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**fetch: hablar con APIs del mundo** — sin copiar y pegar de la lección.
...
# Tema: 16. fetch: hablar con APIs del mundo
```
