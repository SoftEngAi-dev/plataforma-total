# 🛠 Ejercicio práctico — 7. Bucles: for, while y recorrer colecciones

> 📚 JavaScript — De Cero a Experto · Lección 7 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Bucles: for, while y recorrer colecciones** — sin copiar y pegar de la lección.
...
# Tema: 7. Bucles: for, while y recorrer colecciones
```
