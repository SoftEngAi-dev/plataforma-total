# 🛠 Ejercicio práctico — 12. JSON: el idioma universal de los datos

> 📚 JavaScript — De Cero a Experto · Lección 12 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**JSON: el idioma universal de los datos** — sin copiar y pegar de la lección.
...
# Tema: 12. JSON: el idioma universal de los datos
```
