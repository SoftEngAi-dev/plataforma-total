# 🛠 Ejercicio práctico — 1. React Native: App = componentes que ya sabes

> 📚 React Native — Móvil con Tu Stack Web · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**React Native: App = componentes que ya sabes** — sin copiar y pegar de la lección.
...
# Tema: 1. React Native: App = componentes que ya sabes
```
