# 🛠 Ejercicio práctico — 4. Proyecto: app móvil completa con Expo

> 📚 React Native — Móvil con Tu Stack Web · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: app móvil completa con Expo** — sin copiar y pegar de la lección.
...
# Tema: 4. Proyecto: app móvil completa con Expo
```
