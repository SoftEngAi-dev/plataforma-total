# 🛠 Ejercicio práctico — 3. TextInput, estado y persistencia (AsyncStorage)

> 📚 React Native — Móvil con Tu Stack Web · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**TextInput, estado y persistencia (AsyncStorage)** — sin copiar y pegar de la lección.
...
# Tema: 3. TextInput, estado y persistencia (AsyncStorage)
```
