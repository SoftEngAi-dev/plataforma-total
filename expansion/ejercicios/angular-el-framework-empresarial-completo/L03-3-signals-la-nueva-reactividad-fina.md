# 🛠 Ejercicio práctico — 3. Signals: la nueva reactividad fina

> 📚 Angular — El Framework Empresarial Completo · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Signals: la nueva reactividad fina** — sin copiar y pegar de la lección.
...
# Tema: 3. Signals: la nueva reactividad fina
```
