# 🛠 Ejercicio práctico — 2. Servicios e inyección de dependencias: la joya oculta

> 📚 Angular — El Framework Empresarial Completo · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Servicios e inyección de dependencias: la joya oculta** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.ts`) y escribe el código desde cero.
...
# Tema: 2. Servicios e inyección de dependencias: la joya oculta
```
