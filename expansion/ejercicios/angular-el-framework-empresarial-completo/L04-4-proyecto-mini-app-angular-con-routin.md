# 🛠 Ejercicio práctico — 4. Proyecto: mini-app Angular con routing

> 📚 Angular — El Framework Empresarial Completo · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: mini-app Angular con routing** — sin copiar y pegar de la lección.
...
# Tema: 4. Proyecto: mini-app Angular con routing
```
