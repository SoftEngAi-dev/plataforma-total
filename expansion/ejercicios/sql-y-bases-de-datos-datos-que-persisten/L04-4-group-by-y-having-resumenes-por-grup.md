# 🛠 Ejercicio práctico — 4. GROUP BY y HAVING: resúmenes por grupos

> 📚 SQL y Bases de Datos — Datos que Persisten · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**GROUP BY y HAVING: resúmenes por grupos** — sin copiar y pegar de la lección.
...
# Tema: 4. GROUP BY y HAVING: resúmenes por grupos
```
