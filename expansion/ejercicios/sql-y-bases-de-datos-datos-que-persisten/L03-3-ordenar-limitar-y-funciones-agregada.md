# 🛠 Ejercicio práctico — 3. Ordenar, limitar y funciones agregadas

> 📚 SQL y Bases de Datos — Datos que Persisten · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Ordenar, limitar y funciones agregadas** — sin copiar y pegar de la lección.
...
# Tema: 3. Ordenar, limitar y funciones agregadas
```
