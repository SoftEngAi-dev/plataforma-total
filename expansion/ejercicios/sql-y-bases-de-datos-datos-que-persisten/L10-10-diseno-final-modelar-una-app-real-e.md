# 🛠 Ejercicio práctico — 10. Diseño final: modelar una app real en SQL

> 📚 SQL y Bases de Datos — Datos que Persisten · Lección 10 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Diseño final: modelar una app real en SQL** — sin copiar y pegar de la lección.
...
# Tema: 10. Diseño final: modelar una app real en SQL
```
