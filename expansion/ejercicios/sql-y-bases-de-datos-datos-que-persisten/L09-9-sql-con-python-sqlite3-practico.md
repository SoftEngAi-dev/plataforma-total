# 🛠 Ejercicio práctico — 9. SQL con Python: sqlite3 práctico

> 📚 SQL y Bases de Datos — Datos que Persisten · Lección 9 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**SQL con Python: sqlite3 práctico** — sin copiar y pegar de la lección.
...
# Tema: 9. SQL con Python: sqlite3 práctico
```
