# 🛠 Ejercicio práctico — 8. Índices y transacciones: velocidad y seguridad

> 📚 SQL y Bases de Datos — Datos que Persisten · Lección 8 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Índices y transacciones: velocidad y seguridad** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.sql`) y escribe el código desde cero.
...
# Tema: 8. Índices y transacciones: velocidad y seguridad
```
