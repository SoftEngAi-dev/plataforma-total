# 🛠 Ejercicio práctico — 5. CREATE, INSERT, UPDATE, DELETE: escribir datos

> 📚 SQL y Bases de Datos — Datos que Persisten · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**CREATE, INSERT, UPDATE, DELETE: escribir datos** — sin copiar y pegar de la lección.
...
# Tema: 5. CREATE, INSERT, UPDATE, DELETE: escribir datos
```
