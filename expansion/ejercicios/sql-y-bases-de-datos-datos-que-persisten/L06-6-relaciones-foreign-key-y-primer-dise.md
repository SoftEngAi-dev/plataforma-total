# 🛠 Ejercicio práctico — 6. Relaciones: FOREIGN KEY y primer diseño

> 📚 SQL y Bases de Datos — Datos que Persisten · Lección 6 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Relaciones: FOREIGN KEY y primer diseño** — sin copiar y pegar de la lección.
...
# Tema: 6. Relaciones: FOREIGN KEY y primer diseño
```
