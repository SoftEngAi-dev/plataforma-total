# 🛠 Ejercicio práctico — 2. SELECT con WHERE: filtrar con precisión

> 📚 SQL y Bases de Datos — Datos que Persisten · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**SELECT con WHERE: filtrar con precisión** — sin copiar y pegar de la lección.
...
# Tema: 2. SELECT con WHERE: filtrar con precisión
```
