# 🛠 Ejercicio práctico — 1. Python: instalación y primer programa

> 📚 Python — De Cero a Profesional · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Python: instalación y primer programa** — sin copiar y pegar de la lección.
...
# Tema: 1. Python: instalación y primer programa
```
