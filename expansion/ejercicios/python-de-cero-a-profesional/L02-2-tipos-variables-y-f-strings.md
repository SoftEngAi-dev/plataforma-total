# 🛠 Ejercicio práctico — 2. Tipos, variables y f-strings

> 📚 Python — De Cero a Profesional · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Tipos, variables y f-strings** — sin copiar y pegar de la lección.
...
# Tema: 2. Tipos, variables y f-strings
```
