# 🛠 Ejercicio práctico — 15. Python para datos: tu primer análisis real

> 📚 Python — De Cero a Profesional · Lección 15 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Python para datos: tu primer análisis real** — sin copiar y pegar de la lección.
...
# Tema: 15. Python para datos: tu primer análisis real
```
