# 🛠 Ejercicio práctico — 8. Funciones: parámetros, return y scope

> 📚 Python — De Cero a Profesional · Lección 8 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Funciones: parámetros, return y scope** — sin copiar y pegar de la lección.
...
# Tema: 8. Funciones: parámetros, return y scope
```
