# 🛠 Ejercicio práctico — 6. Condicionales y verdad en Python

> 📚 Python — De Cero a Profesional · Lección 6 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Condicionales y verdad en Python** — sin copiar y pegar de la lección.
...
# Tema: 6. Condicionales y verdad en Python
```
