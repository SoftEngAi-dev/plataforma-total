# 🛠 Ejercicio práctico — 5. Strings: métodos que usarás a diario

> 📚 Python — De Cero a Profesional · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Strings: métodos que usarás a diario** — sin copiar y pegar de la lección.
...
# Tema: 5. Strings: métodos que usarás a diario
```
