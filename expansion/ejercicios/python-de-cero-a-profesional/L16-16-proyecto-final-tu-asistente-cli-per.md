# 🛠 Ejercicio práctico — 16. Proyecto final: tu asistente CLI personal

> 📚 Python — De Cero a Profesional · Lección 16 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto final: tu asistente CLI personal** — sin copiar y pegar de la lección.
...
# Tema: 16. Proyecto final: tu asistente CLI personal
```
