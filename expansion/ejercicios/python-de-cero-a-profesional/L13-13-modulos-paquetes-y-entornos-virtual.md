# 🛠 Ejercicio práctico — 13. Módulos, paquetes y entornos virtuales

> 📚 Python — De Cero a Profesional · Lección 13 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Módulos, paquetes y entornos virtuales** — sin copiar y pegar de la lección.
...
# Tema: 13. Módulos, paquetes y entornos virtuales
```
