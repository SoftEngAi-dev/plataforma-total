# 🛠 Ejercicio práctico — 11. Comprensiones avanzadas y lambda: código que se lee

> 📚 Python — De Cero a Profesional · Lección 11 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Comprensiones avanzadas y lambda: código que se lee** — sin copiar y pegar de la lección.
...
# Tema: 11. Comprensiones avanzadas y lambda: código que se lee
```
