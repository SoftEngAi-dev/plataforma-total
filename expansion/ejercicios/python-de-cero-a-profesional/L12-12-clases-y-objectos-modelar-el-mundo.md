# 🛠 Ejercicio práctico — 12. Clases y objectos: modelar el mundo

> 📚 Python — De Cero a Profesional · Lección 12 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Clases y objectos: modelar el mundo** — sin copiar y pegar de la lección.
...
# Tema: 12. Clases y objectos: modelar el mundo
```
