# 🛠 Ejercicio práctico — 14. Librería estándar: 10 joyas incluidas

> 📚 Python — De Cero a Profesional · Lección 14 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Librería estándar: 10 joyas incluidas** — sin copiar y pegar de la lección.
...
# Tema: 14. Librería estándar: 10 joyas incluidas
```
