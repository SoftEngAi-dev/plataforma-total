# 🛠 Ejercicio práctico — 9. Archivos: leer, escribir y JSON

> 📚 Python — De Cero a Profesional · Lección 9 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Archivos: leer, escribir y JSON** — sin copiar y pegar de la lección.
...
# Tema: 9. Archivos: leer, escribir y JSON
```
