# 🛠 Ejercicio práctico — 4. Diccionarios y sets: clave-valor y unicidad

> 📚 Python — De Cero a Profesional · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Diccionarios y sets: clave-valor y unicidad** — sin copiar y pegar de la lección.
...
# Tema: 4. Diccionarios y sets: clave-valor y unicidad
```
