# 🛠 Ejercicio práctico — 3. Listas y tuplas: colecciones ordenadas

> 📚 Python — De Cero a Profesional · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Listas y tuplas: colecciones ordenadas** — sin copiar y pegar de la lección.
...
# Tema: 3. Listas y tuplas: colecciones ordenadas
```
