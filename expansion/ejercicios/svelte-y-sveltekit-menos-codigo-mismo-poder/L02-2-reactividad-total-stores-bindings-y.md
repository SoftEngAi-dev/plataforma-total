# 🛠 Ejercicio práctico — 2. Reactividad total: stores, bindings y formularios

> 📚 Svelte y SvelteKit — Menos Código, Mismo Poder · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Reactividad total: stores, bindings y formularios** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.svelte`) y escribe el código desde cero.
...
# Tema: 2. Reactividad total: stores, bindings y formularios
```
