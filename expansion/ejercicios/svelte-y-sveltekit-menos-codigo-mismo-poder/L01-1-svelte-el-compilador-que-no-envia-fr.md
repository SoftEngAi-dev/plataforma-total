# 🛠 Ejercicio práctico — 1. Svelte: el compilador que no envía framework

> 📚 Svelte y SvelteKit — Menos Código, Mismo Poder · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Svelte: el compilador que no envía framework** — sin copiar y pegar de la lección.
...
# Tema: 1. Svelte: el compilador que no envía framework
```
