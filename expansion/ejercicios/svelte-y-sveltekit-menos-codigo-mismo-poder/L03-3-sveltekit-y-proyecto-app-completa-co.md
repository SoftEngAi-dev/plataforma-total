# 🛠 Ejercicio práctico — 3. SvelteKit y proyecto: app completa con rutas

> 📚 Svelte y SvelteKit — Menos Código, Mismo Poder · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**SvelteKit y proyecto: app completa con rutas** — sin copiar y pegar de la lección.
...
# Tema: 3. SvelteKit y proyecto: app completa con rutas
```
