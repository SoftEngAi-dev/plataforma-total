# 🛠 Ejercicio práctico — 3. Tus herramientas: progreso, racha y certificados

> 📚 Ruta Maestra — Cómo Usar Esta Plataforma · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Tus herramientas: progreso, racha y certificados** — sin copiar y pegar de la lección.
...
# Tema: 3. Tus herramientas: progreso, racha y certificados
```
