# 🛠 Ejercicio práctico — 2. Cómo estudiar una lección (método comprobado)

> 📚 Ruta Maestra — Cómo Usar Esta Plataforma · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Cómo estudiar una lección (método comprobado)** — sin copiar y pegar de la lección.
...
# Tema: 2. Cómo estudiar una lección (método comprobado)
```
