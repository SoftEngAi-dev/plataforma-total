# 🛠 Ejercicio práctico — 1. El mapa completo: 41 cursos, un objetivo

> 📚 Ruta Maestra — Cómo Usar Esta Plataforma · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**El mapa completo: 41 cursos, un objetivo** — sin copiar y pegar de la lección.
...
# Tema: 1. El mapa completo: 41 cursos, un objetivo
```
