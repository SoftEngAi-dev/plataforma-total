# 🛠 Ejercicio práctico — 6. Proyecto: CRUD completo en Laravel

> 📚 PHP y Laravel — El Backend Que Alimenta la Web · Lección 6 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: CRUD completo en Laravel** — sin copiar y pegar de la lección.
...
# Tema: 6. Proyecto: CRUD completo en Laravel
```
