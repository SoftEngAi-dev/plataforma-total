# 🛠 Ejercicio práctico — 1. PHP: el gigante subestimado

> 📚 PHP y Laravel — El Backend Que Alimenta la Web · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**PHP: el gigante subestimado** — sin copiar y pegar de la lección.
...
# Tema: 1. PHP: el gigante subestimado
```
