# 🛠 Ejercicio práctico — 3. PDO: bases de datos sin inyección

> 📚 PHP y Laravel — El Backend Que Alimenta la Web · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**PDO: bases de datos sin inyección** — sin copiar y pegar de la lección.
...
# Tema: 3. PDO: bases de datos sin inyección
```
