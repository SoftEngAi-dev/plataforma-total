# 🛠 Ejercicio práctico — 4. Frameworks modernos y despliegue edge

> 📚 🍞 Bun & Deno — Los Nuevos Runtimes · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Frameworks modernos y despliegue edge** — sin copiar y pegar de la lección.
...
# Tema: 4. Frameworks modernos y despliegue edge
```
