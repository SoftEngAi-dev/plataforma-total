# 🛠 Ejercicio práctico — 1. Por qué existen: más allá de Node

> 📚 🍞 Bun & Deno — Los Nuevos Runtimes · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Por qué existen: más allá de Node** — sin copiar y pegar de la lección.
...
# Tema: 1. Por qué existen: más allá de Node
```
