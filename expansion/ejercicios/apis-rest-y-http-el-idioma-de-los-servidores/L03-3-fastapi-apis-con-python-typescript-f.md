# 🛠 Ejercicio práctico — 3. FastAPI: APIs con Python + TypeScript feel

> 📚 APIs REST y HTTP — El Idioma de los Servidores · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**FastAPI: APIs con Python + TypeScript feel** — sin copiar y pegar de la lección.
...
# Tema: 3. FastAPI: APIs con Python + TypeScript feel
```
