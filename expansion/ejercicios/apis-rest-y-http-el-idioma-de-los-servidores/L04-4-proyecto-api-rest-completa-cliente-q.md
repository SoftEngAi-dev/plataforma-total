# 🛠 Ejercicio práctico — 4. Proyecto: API REST completa+cliente que la consume

> 📚 APIs REST y HTTP — El Idioma de los Servidores · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: API REST completa+cliente que la consume** — sin copiar y pegar de la lección.
...
# Tema: 4. Proyecto: API REST completa+cliente que la consume
```
