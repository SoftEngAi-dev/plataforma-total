# 🛠 Ejercicio práctico — 1. HTTP: el protocolo que habla el mundo

> 📚 APIs REST y HTTP — El Idioma de los Servidores · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**HTTP: el protocolo que habla el mundo** — sin copiar y pegar de la lección.
...
# Tema: 1. HTTP: el protocolo que habla el mundo
```
