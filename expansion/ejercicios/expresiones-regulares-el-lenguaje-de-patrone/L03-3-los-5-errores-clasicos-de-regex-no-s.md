# 🛠 Ejercicio práctico — 3. Los 5 errores clásicos de regex (no sufras estos)

> 📚 Expresiones Regulares — El Lenguaje de Patrones · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Los 5 errores clásicos de regex (no sufras estos)** — sin copiar y pegar de la lección.
...
# Tema: 3. Los 5 errores clásicos de regex (no sufras estos)
```
