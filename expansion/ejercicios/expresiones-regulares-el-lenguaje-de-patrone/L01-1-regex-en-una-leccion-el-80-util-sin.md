# 🛠 Ejercicio práctico — 1. Regex en una lección: el 80% útil sin dolor

> 📚 Expresiones Regulares — El Lenguaje de Patrones · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Regex en una lección: el 80% útil sin dolor** — sin copiar y pegar de la lección.
...
# Tema: 1. Regex en una lección: el 80% útil sin dolor
```
