# 🛠 Ejercicio práctico — 1. App Router: Server Components por defecto

> 📚 ▲ Next.js — El React Moderno · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**App Router: Server Components por defecto** — sin copiar y pegar de la lección.
...
# Tema: 1. App Router: Server Components por defecto
```
