# 🛠 Ejercicio práctico — 3. Datos: fetch con caché, loading.tsx y error.tsx

> 📚 ▲ Next.js — El React Moderno · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Datos: fetch con caché, loading.tsx y error.tsx** — sin copiar y pegar de la lección.
...
# Tema: 3. Datos: fetch con caché, loading.tsx y error.tsx
```
