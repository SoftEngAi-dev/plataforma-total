# 🛠 Ejercicio práctico — 4. Server Actions: mutaciones sin escribir APIs

> 📚 ▲ Next.js — El React Moderno · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Server Actions: mutaciones sin escribir APIs** — sin copiar y pegar de la lección.
...
# Tema: 4. Server Actions: mutaciones sin escribir APIs
```
