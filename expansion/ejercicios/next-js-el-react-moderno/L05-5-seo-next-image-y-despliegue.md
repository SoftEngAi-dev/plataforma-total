# 🛠 Ejercicio práctico — 5. SEO, next/image y despliegue

> 📚 ▲ Next.js — El React Moderno · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**SEO, next/image y despliegue** — sin copiar y pegar de la lección.
...
# Tema: 5. SEO, next/image y despliegue
```
