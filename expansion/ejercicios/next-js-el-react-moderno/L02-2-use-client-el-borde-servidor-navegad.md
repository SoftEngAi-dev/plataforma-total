# 🛠 Ejercicio práctico — 2. 'use client': el borde servidor/navegador

> 📚 ▲ Next.js — El React Moderno · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**'use client': el borde servidor/navegador** — sin copiar y pegar de la lección.
...
# Tema: 2. 'use client': el borde servidor/navegador
```
