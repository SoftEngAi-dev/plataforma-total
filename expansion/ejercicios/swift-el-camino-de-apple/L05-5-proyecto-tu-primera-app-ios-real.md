# 🛠 Ejercicio práctico — 5. Proyecto: tu primera app iOS real

> 📚 Swift — El Camino de Apple · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: tu primera app iOS real** — sin copiar y pegar de la lección.
...
# Tema: 5. Proyecto: tu primera app iOS real
```
