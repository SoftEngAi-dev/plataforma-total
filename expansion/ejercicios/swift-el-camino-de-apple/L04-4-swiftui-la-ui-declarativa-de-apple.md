# 🛠 Ejercicio práctico — 4. SwiftUI: la UI declarativa de Apple

> 📚 Swift — El Camino de Apple · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**SwiftUI: la UI declarativa de Apple** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.swift`) y escribe el código desde cero.
...
# Tema: 4. SwiftUI: la UI declarativa de Apple
```
