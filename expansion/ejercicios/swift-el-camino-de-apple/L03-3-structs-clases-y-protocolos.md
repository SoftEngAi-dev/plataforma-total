# 🛠 Ejercicio práctico — 3. Structs, clases y protocolos

> 📚 Swift — El Camino de Apple · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Structs, clases y protocolos** — sin copiar y pegar de la lección.
...
# Tema: 3. Structs, clases y protocolos
```
