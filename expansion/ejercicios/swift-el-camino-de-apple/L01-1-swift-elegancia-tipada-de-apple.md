# 🛠 Ejercicio práctico — 1. Swift: elegancia tipada de Apple

> 📚 Swift — El Camino de Apple · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Swift: elegancia tipada de Apple** — sin copiar y pegar de la lección.
...
# Tema: 1. Swift: elegancia tipada de Apple
```
