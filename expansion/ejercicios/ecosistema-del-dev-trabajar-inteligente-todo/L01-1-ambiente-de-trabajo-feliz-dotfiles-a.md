# 🛠 Ejercicio práctico — 1. Ambiente de trabajo feliz: dotfiles, alias y costumbres

> 📚 Ecosistema del Dev — Trabajar Inteligente Todos los Días · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Ambiente de trabajo feliz: dotfiles, alias y costumbres** — sin copiar y pegar de la lección.
...
# Tema: 1. Ambiente de trabajo feliz: dotfiles, alias y costumbres
```
