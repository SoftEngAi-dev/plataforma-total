# 🛠 Ejercicio práctico — 2. Markdown + documentación que La gente lee

> 📚 Ecosistema del Dev — Trabajar Inteligente Todos los Días · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Markdown + documentación que La gente lee** — sin copiar y pegar de la lección.
...
# Tema: 2. Markdown + documentación que La gente lee
```
