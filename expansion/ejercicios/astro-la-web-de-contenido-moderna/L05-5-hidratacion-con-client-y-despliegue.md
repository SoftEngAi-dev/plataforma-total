# 🛠 Ejercicio práctico — 5. Hidratación con client:* y despliegue

> 📚 🚀 Astro — La Web de Contenido Moderna · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Hidratación con client:* y despliegue** — sin copiar y pegar de la lección.
...
# Tema: 5. Hidratación con client:* y despliegue
```
