# 🛠 Ejercicio práctico — 2. Componentes Astro: props, slots y estilos con scope

> 📚 🚀 Astro — La Web de Contenido Moderna · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Componentes Astro: props, slots y estilos con scope** — sin copiar y pegar de la lección.
...
# Tema: 2. Componentes Astro: props, slots y estilos con scope
```
