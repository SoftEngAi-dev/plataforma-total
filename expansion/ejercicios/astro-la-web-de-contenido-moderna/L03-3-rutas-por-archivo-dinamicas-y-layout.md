# 🛠 Ejercicio práctico — 3. Rutas por archivo, dinámicas y layouts

> 📚 🚀 Astro — La Web de Contenido Moderna · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Rutas por archivo, dinámicas y layouts** — sin copiar y pegar de la lección.
...
# Tema: 3. Rutas por archivo, dinámicas y layouts
```
