# 🛠 Ejercicio práctico — 4. Content Collections: Markdown con tipos

> 📚 🚀 Astro — La Web de Contenido Moderna · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Content Collections: Markdown con tipos** — sin copiar y pegar de la lección.
...
# Tema: 4. Content Collections: Markdown con tipos
```
