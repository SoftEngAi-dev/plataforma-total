# 🛠 Ejercicio práctico — 3. Result y Option: errores como parte del tipo

> 📚 Rust — Velocidad de C sin Miedo a los Crashes · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Result y Option: errores como parte del tipo** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.rs`) y escribe el código desde cero.
...
# Tema: 3. Result y Option: errores como parte del tipo
```
