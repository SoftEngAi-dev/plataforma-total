# 🛠 Ejercicio práctico — 5. Proyecto: CLI real en Rust con clap

> 📚 Rust — Velocidad de C sin Miedo a los Crashes · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: CLI real en Rust con clap** — sin copiar y pegar de la lección.
...
# Tema: 5. Proyecto: CLI real en Rust con clap
```
