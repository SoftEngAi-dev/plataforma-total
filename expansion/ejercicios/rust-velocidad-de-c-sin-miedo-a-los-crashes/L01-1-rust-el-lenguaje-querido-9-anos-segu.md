# 🛠 Ejercicio práctico — 1. Rust: el lenguaje querido 9 años seguidos

> 📚 Rust — Velocidad de C sin Miedo a los Crashes · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Rust: el lenguaje querido 9 años seguidos** — sin copiar y pegar de la lección.
...
# Tema: 1. Rust: el lenguaje querido 9 años seguidos
```
