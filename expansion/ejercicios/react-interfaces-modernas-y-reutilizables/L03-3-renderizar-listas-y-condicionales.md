# 🛠 Ejercicio práctico — 3. Renderizar listas y condicionales

> 📚 React — Interfaces Modernas y Reutilizables · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Renderizar listas y condicionales** — sin copiar y pegar de la lección.
...
# Tema: 3. Renderizar listas y condicionales
```
