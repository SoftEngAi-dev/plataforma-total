# 🛠 Ejercicio práctico — 5. useEffect: sincronizar con el mundo exterior

> 📚 React — Interfaces Modernas y Reutilizables · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**useEffect: sincronizar con el mundo exterior** — sin copiar y pegar de la lección.
...
# Tema: 5. useEffect: sincronizar con el mundo exterior
```
