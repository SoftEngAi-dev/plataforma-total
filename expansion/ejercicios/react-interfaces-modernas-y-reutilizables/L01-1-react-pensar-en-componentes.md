# 🛠 Ejercicio práctico — 1. React: pensar en componentes

> 📚 React — Interfaces Modernas y Reutilizables · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**React: pensar en componentes** — sin copiar y pegar de la lección.
...
# Tema: 1. React: pensar en componentes
```
