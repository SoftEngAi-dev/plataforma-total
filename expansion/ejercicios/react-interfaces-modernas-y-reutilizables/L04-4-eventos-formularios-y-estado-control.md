# 🛠 Ejercicio práctico — 4. Eventos, formularios y estado controlado

> 📚 React — Interfaces Modernas y Reutilizables · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Eventos, formularios y estado controlado** — sin copiar y pegar de la lección.
...
# Tema: 4. Eventos, formularios y estado controlado
```
