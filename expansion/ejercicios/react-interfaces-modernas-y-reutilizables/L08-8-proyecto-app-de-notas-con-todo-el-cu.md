# 🛠 Ejercicio práctico — 8. Proyecto: app de notas con todo el curso

> 📚 React — Interfaces Modernas y Reutilizables · Lección 8 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: app de notas con todo el curso** — sin copiar y pegar de la lección.
...
# Tema: 8. Proyecto: app de notas con todo el curso
```
