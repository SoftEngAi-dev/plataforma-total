# 🛠 Ejercicio práctico — 4. Árboles de decisión y RandomForest: los caballos de batalla

> 📚 Machine Learning — Primer Contacto Real · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Árboles de decisión y RandomForest: los caballos de batalla** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.py`) y escribe el código desde cero.
...
# Tema: 4. Árboles de decisión y RandomForest: los caballos de batalla
```
