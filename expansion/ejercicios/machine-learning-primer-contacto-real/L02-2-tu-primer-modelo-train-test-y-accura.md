# 🛠 Ejercicio práctico — 2. Tu primer modelo: train/test y accuracy real

> 📚 Machine Learning — Primer Contacto Real · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Tu primer modelo: train/test y accuracy real** — sin copiar y pegar de la lección.
...
# Tema: 2. Tu primer modelo: train/test y accuracy real
```
