# 🛠 Ejercicio práctico — 3. Overfitting vs underfitting y validación

> 📚 Machine Learning — Primer Contacto Real · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Overfitting vs underfitting y validación** — sin copiar y pegar de la lección.
...
# Tema: 3. Overfitting vs underfitting y validación
```
