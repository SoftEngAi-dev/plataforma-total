# 🛠 Ejercicio práctico — 3. Express: el servidor web minimalista

> 📚 Node.js — JavaScript en el Servidor · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Express: el servidor web minimalista** — sin copiar y pegar de la lección.
...
# Tema: 3. Express: el servidor web minimalista
```
