# 🛠 Ejercicio práctico — 1. Node: sacar JS del navegador

> 📚 Node.js — JavaScript en el Servidor · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Node: sacar JS del navegador** — sin copiar y pegar de la lección.
...
# Tema: 1. Node: sacar JS del navegador
```
