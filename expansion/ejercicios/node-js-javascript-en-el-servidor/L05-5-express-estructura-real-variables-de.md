# 🛠 Ejercicio práctico — 5. Express + estructura real + variables de entorno

> 📚 Node.js — JavaScript en el Servidor · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Express + estructura real + variables de entorno** — sin copiar y pegar de la lección.
...
# Tema: 5. Express + estructura real + variables de entorno
```
