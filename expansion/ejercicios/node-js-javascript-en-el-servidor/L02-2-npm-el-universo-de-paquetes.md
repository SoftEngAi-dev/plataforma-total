# 🛠 Ejercicio práctico — 2. npm: el universo de paquetes

> 📚 Node.js — JavaScript en el Servidor · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**npm: el universo de paquetes** — sin copiar y pegar de la lección.
...
# Tema: 2. npm: el universo de paquetes
```
