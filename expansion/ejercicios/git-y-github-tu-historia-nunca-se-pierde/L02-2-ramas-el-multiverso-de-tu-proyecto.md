# 🛠 Ejercicio práctico — 2. Ramas: el multiverso de tu proyecto

> 📚 Git y GitHub — Tu Historia Nunca Se Pierde · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Ramas: el multiverso de tu proyecto** — sin copiar y pegar de la lección.
...
# Tema: 2. Ramas: el multiverso de tu proyecto
```
