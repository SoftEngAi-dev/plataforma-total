# 🛠 Ejercicio práctico — 1. Git mental: qué es un commit

> 📚 Git y GitHub — Tu Historia Nunca Se Pierde · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Git mental: qué es un commit** — sin copiar y pegar de la lección.
...
# Tema: 1. Git mental: qué es un commit
```
