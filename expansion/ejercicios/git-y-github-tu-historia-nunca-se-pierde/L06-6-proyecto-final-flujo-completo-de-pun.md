# 🛠 Ejercicio práctico — 6. Proyecto final: flujo completo de punta a punta

> 📚 Git y GitHub — Tu Historia Nunca Se Pierde · Lección 6 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto final: flujo completo de punta a punta** — sin copiar y pegar de la lección.
...
# Tema: 6. Proyecto final: flujo completo de punta a punta
```
