# 🛠 Ejercicio práctico — 3. Deshacer: checkout, restore, revert, reset (la tabla salvadora)

> 📚 Git y GitHub — Tu Historia Nunca Se Pierde · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Deshacer: checkout, restore, revert, reset (la tabla salvadora)** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.sh`) y escribe el código desde cero.
...
# Tema: 3. Deshacer: checkout, restore, revert, reset (la tabla salvadora)
```
