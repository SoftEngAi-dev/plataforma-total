# 🛠 Ejercicio práctico — 5. Proyecto: blog Rails con todo lo anterior

> 📚 Ruby on Rails — La Felicidad del Desarrollador · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: blog Rails con todo lo anterior** — sin copiar y pegar de la lección.
...
# Tema: 5. Proyecto: blog Rails con todo lo anterior
```
