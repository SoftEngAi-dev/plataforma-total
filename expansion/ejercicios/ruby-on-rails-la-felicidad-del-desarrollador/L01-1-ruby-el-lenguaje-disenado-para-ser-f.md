# 🛠 Ejercicio práctico — 1. Ruby: el lenguaje diseñado para ser feliz

> 📚 Ruby on Rails — La Felicidad del Desarrollador · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Ruby: el lenguaje diseñado para ser feliz** — sin copiar y pegar de la lección.
...
# Tema: 1. Ruby: el lenguaje diseñado para ser feliz
```
