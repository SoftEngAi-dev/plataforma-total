# 🛠 Ejercicio práctico — 2. Rails: convención sobre configuración

> 📚 Ruby on Rails — La Felicidad del Desarrollador · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Rails: convención sobre configuración** — sin copiar y pegar de la lección.
...
# Tema: 2. Rails: convención sobre configuración
```
