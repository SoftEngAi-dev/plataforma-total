# 🛠 Ejercicio práctico — 3. ActiveRecord: tu base de datos con sabor Ruby

> 📚 Ruby on Rails — La Felicidad del Desarrollador · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**ActiveRecord: tu base de datos con sabor Ruby** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.rb`) y escribe el código desde cero.
...
# Tema: 3. ActiveRecord: tu base de datos con sabor Ruby
```
