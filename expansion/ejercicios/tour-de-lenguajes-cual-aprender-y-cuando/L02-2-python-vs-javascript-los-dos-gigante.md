# 🛠 Ejercicio práctico — 2. Python vs JavaScript: los dos gigantes y cuándo cada uno

> 📚 Tour de Lenguajes — Cuál Aprender y Cuándo · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Python vs JavaScript: los dos gigantes y cuándo cada uno** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.r`) y escribe el código desde cero.
...
# Tema: 2. Python vs JavaScript: los dos gigantes y cuándo cada uno
```
