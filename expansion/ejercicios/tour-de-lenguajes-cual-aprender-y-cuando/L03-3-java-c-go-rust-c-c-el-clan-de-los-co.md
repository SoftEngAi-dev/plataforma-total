# 🛠 Ejercicio práctico — 3. Java, C#, Go, Rust, C/C++: el clan de los compilados

> 📚 Tour de Lenguajes — Cuál Aprender y Cuándo · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Java, C#, Go, Rust, C/C++: el clan de los compilados** — sin copiar y pegar de la lección.
...
# Tema: 3. Java, C#, Go, Rust, C/C++: el clan de los compilados
```
