# 🛠 Ejercicio práctico — 2. Data frames: la tabla de trabajo eterna

> 📚 R y Estadística — El Idioma de los Datos · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Data frames: la tabla de trabajo eterna** — sin copiar y pegar de la lección.
...
# Tema: 2. Data frames: la tabla de trabajo eterna
```
