# 🛠 Ejercicio práctico — 1. R en 15 minutos: vectores, el corazón

> 📚 R y Estadística — El Idioma de los Datos · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**R en 15 minutos: vectores, el corazón** — sin copiar y pegar de la lección.
...
# Tema: 1. R en 15 minutos: vectores, el corazón
```
