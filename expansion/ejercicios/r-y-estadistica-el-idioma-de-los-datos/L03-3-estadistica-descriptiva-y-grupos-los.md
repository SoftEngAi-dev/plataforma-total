# 🛠 Ejercicio práctico — 3. Estadística descriptiva y grupos: los números de verdad

> 📚 R y Estadística — El Idioma de los Datos · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Estadística descriptiva y grupos: los números de verdad** — sin copiar y pegar de la lección.
...
# Tema: 3. Estadística descriptiva y grupos: los números de verdad
```
