# 🛠 Ejercicio práctico — 1. DevOps en una frase y el pipeline

> 📚 DevOps y CI/CD — De Tu PC a Producción Sin Sudor · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**DevOps en una frase y el pipeline** — sin copiar y pegar de la lección.
...
# Tema: 1. DevOps en una frase y el pipeline
```
