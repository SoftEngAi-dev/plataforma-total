# 🛠 Ejercicio práctico — 2. GitHub Actions desde cero: tu primer workflow

> 📚 DevOps y CI/CD — De Tu PC a Producción Sin Sudor · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**GitHub Actions desde cero: tu primer workflow** — sin copiar y pegar de la lección.
...
# Tema: 2. GitHub Actions desde cero: tu primer workflow
```
