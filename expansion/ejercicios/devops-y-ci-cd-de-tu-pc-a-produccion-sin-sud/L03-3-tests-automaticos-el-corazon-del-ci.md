# 🛠 Ejercicio práctico — 3. Tests automáticos: el corazón del CI

> 📚 DevOps y CI/CD — De Tu PC a Producción Sin Sudor · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Tests automáticos: el corazón del CI** — sin copiar y pegar de la lección.
...
# Tema: 3. Tests automáticos: el corazón del CI
```
