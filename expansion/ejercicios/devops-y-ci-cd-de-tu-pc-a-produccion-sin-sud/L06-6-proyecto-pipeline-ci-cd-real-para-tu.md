# 🛠 Ejercicio práctico — 6. Proyecto: pipeline CI/CD real para tu app

> 📚 DevOps y CI/CD — De Tu PC a Producción Sin Sudor · Lección 6 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: pipeline CI/CD real para tu app** — sin copiar y pegar de la lección.
...
# Tema: 6. Proyecto: pipeline CI/CD real para tu app
```
