# 🛠 Ejercicio práctico — 5. Monitoreo y logs: saber cuando tu app llora

> 📚 DevOps y CI/CD — De Tu PC a Producción Sin Sudor · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Monitoreo y logs: saber cuando tu app llora** — sin copiar y pegar de la lección.
...
# Tema: 5. Monitoreo y logs: saber cuando tu app llora
```
