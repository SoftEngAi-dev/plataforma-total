# 🛠 Ejercicio práctico — 3. Permisos y procesos: controlar el sistema

> 📚 Linux y Terminal — El Superpoder del Dev · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Permisos y procesos: controlar el sistema** — sin copiar y pegar de la lección.
...
# Tema: 3. Permisos y procesos: controlar el sistema
```
