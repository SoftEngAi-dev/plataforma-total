# 🛠 Ejercicio práctico — 2. Leer, buscar y tuberías: la filosofía Unix

> 📚 Linux y Terminal — El Superpoder del Dev · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Leer, buscar y tuberías: la filosofía Unix** — sin copiar y pegar de la lección.
...
# Tema: 2. Leer, buscar y tuberías: la filosofía Unix
```
