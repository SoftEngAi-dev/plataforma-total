# 🛠 Ejercicio práctico — 1. El sistema de archivos y navegación

> 📚 Linux y Terminal — El Superpoder del Dev · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**El sistema de archivos y navegación** — sin copiar y pegar de la lección.
...
# Tema: 1. El sistema de archivos y navegación
```
