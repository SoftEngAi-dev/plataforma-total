# 🛠 Ejercicio práctico — 5. Scripts Bash: automatiza tu propia vida

> 📚 Linux y Terminal — El Superpoder del Dev · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Scripts Bash: automatiza tu propia vida** — sin copiar y pegar de la lección.
...
# Tema: 5. Scripts Bash: automatiza tu propia vida
```
