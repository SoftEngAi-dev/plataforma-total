# 🛠 Ejercicio práctico — 6. Proyecto: pone tu PC a trabajar sola

> 📚 Linux y Terminal — El Superpoder del Dev · Lección 6 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: pone tu PC a trabajar sola** — sin copiar y pegar de la lección.
...
# Tema: 6. Proyecto: pone tu PC a trabajar sola
```
