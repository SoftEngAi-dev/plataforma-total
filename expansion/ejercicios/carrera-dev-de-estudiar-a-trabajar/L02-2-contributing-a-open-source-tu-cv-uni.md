# 🛠 Ejercicio práctico — 2. Contributing a open source: tu CV universal

> 📚 Carrera Dev — De Estudiar a Trabajar · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Contributing a open source: tu CV universal** — sin copiar y pegar de la lección.
...
# Tema: 2. Contributing a open source: tu CV universal
```
