# 🛠 Ejercicio práctico — 1. C#: lenguaje que ya no es 'de Windows'

> 📚 C# y .NET — El Ecosistema Microsoft Moderno · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**C#: lenguaje que ya no es 'de Windows'** — sin copiar y pegar de la lección.
...
# Tema: 1. C#: lenguaje que ya no es 'de Windows'
```
