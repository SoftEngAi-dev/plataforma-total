# 🛠 Ejercicio práctico — 4. Proyecto: API .NET completa con EF Core

> 📚 C# y .NET — El Ecosistema Microsoft Moderno · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: API .NET completa con EF Core** — sin copiar y pegar de la lección.
...
# Tema: 4. Proyecto: API .NET completa con EF Core
```
