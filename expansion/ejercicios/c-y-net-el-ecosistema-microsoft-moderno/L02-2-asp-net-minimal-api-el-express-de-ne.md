# 🛠 Ejercicio práctico — 2. ASP.NET Minimal API: el Express de .NET

> 📚 C# y .NET — El Ecosistema Microsoft Moderno · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**ASP.NET Minimal API: el Express de .NET** — sin copiar y pegar de la lección.
...
# Tema: 2. ASP.NET Minimal API: el Express de .NET
```
