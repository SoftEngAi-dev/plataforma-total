# 🛠 Ejercicio práctico — 3. Entity Framework Core: la BD como objetos C#

> 📚 C# y .NET — El Ecosistema Microsoft Moderno · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Entity Framework Core: la BD como objetos C#** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.cs`) y escribe el código desde cero.
...
# Tema: 3. Entity Framework Core: la BD como objetos C#
```
