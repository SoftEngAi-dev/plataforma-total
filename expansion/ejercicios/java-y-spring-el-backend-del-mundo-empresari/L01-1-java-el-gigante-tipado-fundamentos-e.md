# 🛠 Ejercicio práctico — 1. Java: el gigante tipado (fundamentos en 15 min)

> 📚 Java y Spring — El Backend del Mundo Empresarial · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Java: el gigante tipado (fundamentos en 15 min)** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.java`) y escribe el código desde cero.
...
# Tema: 1. Java: el gigante tipado (fundamentos en 15 min)
```
