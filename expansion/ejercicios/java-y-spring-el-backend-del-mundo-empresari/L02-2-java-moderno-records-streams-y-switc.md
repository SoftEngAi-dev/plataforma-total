# 🛠 Ejercicio práctico — 2. Java moderno: records, streams y switch nuevo

> 📚 Java y Spring — El Backend del Mundo Empresarial · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Java moderno: records, streams y switch nuevo** — sin copiar y pegar de la lección.
...
# Tema: 2. Java moderno: records, streams y switch nuevo
```
