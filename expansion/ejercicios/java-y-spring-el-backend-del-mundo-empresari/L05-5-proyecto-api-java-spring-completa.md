# 🛠 Ejercicio práctico — 5. Proyecto: API Java/Spring completa

> 📚 Java y Spring — El Backend del Mundo Empresarial · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: API Java/Spring completa** — sin copiar y pegar de la lección.
...
# Tema: 5. Proyecto: API Java/Spring completa
```
