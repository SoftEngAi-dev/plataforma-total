# 🛠 Ejercicio práctico — 3. Spring Boot: API REST en 15 líneas de verdad

> 📚 Java y Spring — El Backend del Mundo Empresarial · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Spring Boot: API REST en 15 líneas de verdad** — sin copiar y pegar de la lección.
...
# Tema: 3. Spring Boot: API REST en 15 líneas de verdad
```
