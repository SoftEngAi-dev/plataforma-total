# 🛠 Ejercicio práctico — 5. GitHub Pages y Netlify: tu estática en 5 minutos

> 📚 Despliegue y Servidores — Tu App al Mundo · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**GitHub Pages y Netlify: tu estática en 5 minutos** — sin copiar y pegar de la lección.
...
# Tema: 5. GitHub Pages y Netlify: tu estática en 5 minutos
```
