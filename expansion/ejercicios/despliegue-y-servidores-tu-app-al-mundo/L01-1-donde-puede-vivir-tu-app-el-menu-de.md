# 🛠 Ejercicio práctico — 1. Dónde puede vivir tu app: el menú de opciones

> 📚 Despliegue y Servidores — Tu App al Mundo · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Dónde puede vivir tu app: el menú de opciones** — sin copiar y pegar de la lección.
...
# Tema: 1. Dónde puede vivir tu app: el menú de opciones
```
