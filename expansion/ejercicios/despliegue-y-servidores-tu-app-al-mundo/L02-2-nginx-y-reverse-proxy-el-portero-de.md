# 🛠 Ejercicio práctico — 2. Nginx y reverse proxy: el portero de tu servidor

> 📚 Despliegue y Servidores — Tu App al Mundo · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Nginx y reverse proxy: el portero de tu servidor** — sin copiar y pegar de la lección.
...
# Tema: 2. Nginx y reverse proxy: el portero de tu servidor
```
