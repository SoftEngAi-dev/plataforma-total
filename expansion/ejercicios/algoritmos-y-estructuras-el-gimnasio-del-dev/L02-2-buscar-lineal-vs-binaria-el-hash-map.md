# 🛠 Ejercicio práctico — 2. Buscar: lineal vs binaria + el hash map

> 📚 Algoritmos y Estructuras — El Gimnasio del Dev · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Buscar: lineal vs binaria + el hash map** — sin copiar y pegar de la lección.
...
# Tema: 2. Buscar: lineal vs binaria + el hash map
```
