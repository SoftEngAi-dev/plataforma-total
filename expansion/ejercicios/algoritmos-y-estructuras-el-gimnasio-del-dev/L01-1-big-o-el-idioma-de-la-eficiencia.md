# 🛠 Ejercicio práctico — 1. Big O: el idioma de la eficiencia

> 📚 Algoritmos y Estructuras — El Gimnasio del Dev · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Big O: el idioma de la eficiencia** — sin copiar y pegar de la lección.
...
# Tema: 1. Big O: el idioma de la eficiencia
```
