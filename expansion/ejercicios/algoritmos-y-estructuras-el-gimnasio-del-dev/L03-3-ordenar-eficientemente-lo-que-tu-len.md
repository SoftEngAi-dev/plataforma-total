# 🛠 Ejercicio práctico — 3. Ordenar eficientemente: lo que tu lenguaje hace por ti

> 📚 Algoritmos y Estructuras — El Gimnasio del Dev · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Ordenar eficientemente: lo que tu lenguaje hace por ti** — sin copiar y pegar de la lección.
...
# Tema: 3. Ordenar eficientemente: lo que tu lenguaje hace por ti
```
