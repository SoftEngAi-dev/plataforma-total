# 🛠 Ejercicio práctico — 1. Docker: qué es y por qué lo necesitas

> 📚 Docker — 'En Mi Máquina Sí Funciona' Resuelto · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Docker: qué es y por qué lo necesitas** — sin copiar y pegar de la lección.
...
# Tema: 1. Docker: qué es y por qué lo necesitas
```
