# 🛠 Ejercicio práctico — 2. Imágenes: descargar y listar

> 📚 Docker — 'En Mi Máquina Sí Funciona' Resuelto · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Imágenes: descargar y listar** — sin copiar y pegar de la lección.
...
# Tema: 2. Imágenes: descargar y listar
```
