# 🛠 Ejercicio práctico — 4. Volúmenes, redes y docker-compose: demasiado para la vida real

> 📚 Docker — 'En Mi Máquina Sí Funciona' Resuelto · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Volúmenes, redes y docker-compose: demasiado para la vida real** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.Dockerfile`) y escribe el código desde cero.
...
# Tema: 4. Volúmenes, redes y docker-compose: demasiado para la vida real
```
