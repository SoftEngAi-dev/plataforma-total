# 🛠 Ejercicio práctico — 4. Proyecto: entrevistae simulada completa

> 📚 Entrevistas Técnicas — Demostrar lo que Sabes · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: entrevistae simulada completa** — sin copiar y pegar de la lección.
...
# Tema: 4. Proyecto: entrevistae simulada completa
```
