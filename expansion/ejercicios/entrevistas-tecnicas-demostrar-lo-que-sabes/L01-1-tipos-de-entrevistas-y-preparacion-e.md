# 🛠 Ejercicio práctico — 1. Tipos de entrevistas y preparación estratégica

> 📚 Entrevistas Técnicas — Demostrar lo que Sabes · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Tipos de entrevistas y preparación estratégica** — sin copiar y pegar de la lección.
...
# Tema: 1. Tipos de entrevistas y preparación estratégica
```
