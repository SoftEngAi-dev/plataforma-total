# 🛠 Ejercicio práctico — 2. Problemas clásicos de código y cómo abordarlos

> 📚 Entrevistas Técnicas — Demostrar lo que Sabes · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Problemas clásicos de código y cómo abordarlos** — sin copiar y pegar de la lección.
...
# Tema: 2. Problemas clásicos de código y cómo abordarlos
```
