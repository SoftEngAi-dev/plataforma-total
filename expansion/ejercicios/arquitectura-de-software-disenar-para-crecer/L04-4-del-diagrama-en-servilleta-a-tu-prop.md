# 🛠 Ejercicio práctico — 4. Del diagrama en servilleta a tu propia arquitectura

> 📚 Arquitectura de Software — Diseñar para Crecer · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Del diagrama en servilleta a tu propia arquitectura** — sin copiar y pegar de la lección.
...
# Tema: 4. Del diagrama en servilleta a tu propia arquitectura
```
