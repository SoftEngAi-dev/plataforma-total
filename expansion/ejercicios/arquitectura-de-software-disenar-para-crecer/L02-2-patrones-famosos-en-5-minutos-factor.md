# 🛠 Ejercicio práctico — 2. Patrones famosos en 5 minutos: Factory, Observer, Strategy, Singleton

> 📚 Arquitectura de Software — Diseñar para Crecer · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Patrones famosos en 5 minutos: Factory, Observer, Strategy, Singleton** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.txt`) y escribe el código desde cero.
...
# Tema: 2. Patrones famosos en 5 minutos: Factory, Observer, Strategy, Singleton
```
