# 🛠 Ejercicio práctico — 1. Principios universales: SOLID abreviado útil

> 📚 Arquitectura de Software — Diseñar para Crecer · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Principios universales: SOLID abreviado útil** — sin copiar y pegar de la lección.
...
# Tema: 1. Principios universales: SOLID abreviado útil
```
