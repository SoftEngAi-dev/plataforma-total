# 🛠 Ejercicio práctico — 3. Microservicios vs monolito: decisión de adultos

> 📚 Arquitectura de Software — Diseñar para Crecer · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Microservicios vs monolito: decisión de adultos** — sin copiar y pegar de la lección.
...
# Tema: 3. Microservicios vs monolito: decisión de adultos
```
