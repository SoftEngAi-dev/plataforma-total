# 🛠 Ejercicio práctico — 4. Proyecto: integra IA local en TU app

> 📚 IA Moderna y LLMs — Trabajar con Modelos Locales · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: integra IA local en TU app** — sin copiar y pegar de la lección.
...
# Tema: 4. Proyecto: integra IA local en TU app
```
