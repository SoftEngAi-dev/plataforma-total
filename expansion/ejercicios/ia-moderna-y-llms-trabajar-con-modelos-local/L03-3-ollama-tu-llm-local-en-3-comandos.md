# 🛠 Ejercicio práctico — 3. Ollama: tu LLM local en 3 comandos

> 📚 IA Moderna y LLMs — Trabajar con Modelos Locales · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Ollama: tu LLM local en 3 comandos** — sin copiar y pegar de la lección.
...
# Tema: 3. Ollama: tu LLM local en 3 comandos
```
