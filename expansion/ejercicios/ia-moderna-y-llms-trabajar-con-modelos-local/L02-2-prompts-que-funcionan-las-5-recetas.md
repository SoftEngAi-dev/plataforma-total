# 🛠 Ejercicio práctico — 2. Prompts que funcionan: las 5 recetas

> 📚 IA Moderna y LLMs — Trabajar con Modelos Locales · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Prompts que funcionan: las 5 recetas** — sin copiar y pegar de la lección.
...
# Tema: 2. Prompts que funcionan: las 5 recetas
```
