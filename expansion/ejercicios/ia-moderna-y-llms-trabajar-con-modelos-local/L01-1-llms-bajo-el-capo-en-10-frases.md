# 🛠 Ejercicio práctico — 1. LLMs bajo el capó (en 10 frases)

> 📚 IA Moderna y LLMs — Trabajar con Modelos Locales · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**LLMs bajo el capó (en 10 frases)** — sin copiar y pegar de la lección.
...
# Tema: 1. LLMs bajo el capó (en 10 frases)
```
