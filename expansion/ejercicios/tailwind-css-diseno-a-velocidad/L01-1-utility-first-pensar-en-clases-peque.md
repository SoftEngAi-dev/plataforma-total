# 🛠 Ejercicio práctico — 1. Utility-first: pensar en clases pequeñas

> 📚 🎨 Tailwind CSS — Diseño a Velocidad · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Utility-first: pensar en clases pequeñas** — sin copiar y pegar de la lección.
...
# Tema: 1. Utility-first: pensar en clases pequeñas
```
