# 🛠 Ejercicio práctico — 4. Personalizar el tema, @apply y valores arbitrarios

> 📚 🎨 Tailwind CSS — Diseño a Velocidad · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Personalizar el tema, @apply y valores arbitrarios** — sin copiar y pegar de la lección.
...
# Tema: 4. Personalizar el tema, @apply y valores arbitrarios
```
