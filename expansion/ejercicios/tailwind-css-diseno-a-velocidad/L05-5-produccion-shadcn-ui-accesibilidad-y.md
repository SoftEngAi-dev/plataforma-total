# 🛠 Ejercicio práctico — 5. Producción: shadcn/ui, accesibilidad y buenas prácticas

> 📚 🎨 Tailwind CSS — Diseño a Velocidad · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Producción: shadcn/ui, accesibilidad y buenas prácticas** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.css`) y escribe el código desde cero.
...
# Tema: 5. Producción: shadcn/ui, accesibilidad y buenas prácticas
```
