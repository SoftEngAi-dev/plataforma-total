# 🛠 Ejercicio práctico — 3. Estados y variantes: hover, dark: y group

> 📚 🎨 Tailwind CSS — Diseño a Velocidad · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Estados y variantes: hover, dark: y group** — sin copiar y pegar de la lección.
...
# Tema: 3. Estados y variantes: hover, dark: y group
```
