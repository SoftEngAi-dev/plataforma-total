# 🛠 Ejercicio práctico — 1. Flutter y Dart: el equipo del cross-platform

> 📚 Flutter — Apps Hermosas con Una Sola Base · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Flutter y Dart: el equipo del cross-platform** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.dart`) y escribe el código desde cero.
...
# Tema: 1. Flutter y Dart: el equipo del cross-platform
```
