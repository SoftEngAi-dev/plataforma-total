# 🛠 Ejercicio práctico — 5. Proyecto: app Flutter completa

> 📚 Flutter — Apps Hermosas con Una Sola Base · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: app Flutter completa** — sin copiar y pegar de la lección.
...
# Tema: 5. Proyecto: app Flutter completa
```
