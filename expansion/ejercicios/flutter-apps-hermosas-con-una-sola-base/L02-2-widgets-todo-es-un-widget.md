# 🛠 Ejercicio práctico — 2. Widgets: TODO es un widget

> 📚 Flutter — Apps Hermosas con Una Sola Base · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Widgets: TODO es un widget** — sin copiar y pegar de la lección.
...
# Tema: 2. Widgets: TODO es un widget
```
