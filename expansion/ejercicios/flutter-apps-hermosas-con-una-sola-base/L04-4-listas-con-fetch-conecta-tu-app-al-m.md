# 🛠 Ejercicio práctico — 4. Listas con fetch: conecta tu app al mundo

> 📚 Flutter — Apps Hermosas con Una Sola Base · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Listas con fetch: conecta tu app al mundo** — sin copiar y pegar de la lección.
...
# Tema: 4. Listas con fetch: conecta tu app al mundo
```
