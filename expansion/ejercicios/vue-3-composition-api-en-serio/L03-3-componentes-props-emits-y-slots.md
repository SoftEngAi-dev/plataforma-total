# 🛠 Ejercicio práctico — 3. Componentes: props, emits y slots

> 📚 💚 Vue 3 — Composition API en Serio · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Componentes: props, emits y slots** — sin copiar y pegar de la lección.
...
# Tema: 3. Componentes: props, emits y slots
```
