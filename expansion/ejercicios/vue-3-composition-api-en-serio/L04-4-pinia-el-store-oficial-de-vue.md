# 🛠 Ejercicio práctico — 4. Pinia: el store oficial de Vue

> 📚 💚 Vue 3 — Composition API en Serio · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Pinia: el store oficial de Vue** — sin copiar y pegar de la lección.
...
# Tema: 4. Pinia: el store oficial de Vue
```
