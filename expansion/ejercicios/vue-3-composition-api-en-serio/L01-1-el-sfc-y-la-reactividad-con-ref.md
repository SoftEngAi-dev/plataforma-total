# 🛠 Ejercicio práctico — 1. El SFC y la reactividad con ref()

> 📚 💚 Vue 3 — Composition API en Serio · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**El SFC y la reactividad con ref()** — sin copiar y pegar de la lección.
...
# Tema: 1. El SFC y la reactividad con ref()
```
