# 🛠 Ejercicio práctico — 5. Nuxt 3: Vue full-stack

> 📚 💚 Vue 3 — Composition API en Serio · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Nuxt 3: Vue full-stack** — sin copiar y pegar de la lección.
