# 🛠 Ejercicio práctico — 1. Svelte 5 con runas: reactividad sin Virtual DOM

> 📚 🔥 SvelteKit & Svelte 5 — Apps Completas · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Svelte 5 con runas: reactividad sin Virtual DOM** — sin copiar y pegar de la lección.
...
# Tema: 1. Svelte 5 con runas: reactividad sin Virtual DOM
```
