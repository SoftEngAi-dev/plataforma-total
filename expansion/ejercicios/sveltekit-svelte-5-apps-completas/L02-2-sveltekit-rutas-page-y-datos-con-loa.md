# 🛠 Ejercicio práctico — 2. SvelteKit: rutas +page y datos con load

> 📚 🔥 SvelteKit & Svelte 5 — Apps Completas · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**SvelteKit: rutas +page y datos con load** — sin copiar y pegar de la lección.
...
# Tema: 2. SvelteKit: rutas +page y datos con load
```
