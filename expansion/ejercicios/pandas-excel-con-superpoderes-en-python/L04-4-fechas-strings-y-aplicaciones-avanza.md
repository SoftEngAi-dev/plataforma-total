# 🛠 Ejercicio práctico — 4. Fechas, strings y aplicaciones avanzadas (los .dt/.str)

> 📚 Pandas — Excel con Superpoderes en Python · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Fechas, strings y aplicaciones avanzadas (los .dt/.str)** — sin copiar y pegar de la lección.
...
# Tema: 4. Fechas, strings y aplicaciones avanzadas (los .dt/.str)
```
