# 🛠 Ejercicio práctico — 3. groupby y agregaciones: análisis de negocio directo

> 📚 Pandas — Excel con Superpoderes en Python · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**groupby y agregaciones: análisis de negocio directo** — sin copiar y pegar de la lección.
...
# Tema: 3. groupby y agregaciones: análisis de negocio directo
```
