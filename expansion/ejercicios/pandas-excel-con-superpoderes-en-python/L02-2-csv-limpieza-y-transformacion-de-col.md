# 🛠 Ejercicio práctico — 2. CSV, limpieza y transformación de columnas

> 📚 Pandas — Excel con Superpoderes en Python · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**CSV, limpieza y transformación de columnas** — sin copiar y pegar de la lección.
...
# Tema: 2. CSV, limpieza y transformación de columnas
```
