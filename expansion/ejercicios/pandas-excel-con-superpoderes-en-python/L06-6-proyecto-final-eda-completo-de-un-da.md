# 🛠 Ejercicio práctico — 6. Proyecto final: EDA completo de un dataset público

> 📚 Pandas — Excel con Superpoderes en Python · Lección 6 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto final: EDA completo de un dataset público** — sin copiar y pegar de la lección.
...
# Tema: 6. Proyecto final: EDA completo de un dataset público
```
