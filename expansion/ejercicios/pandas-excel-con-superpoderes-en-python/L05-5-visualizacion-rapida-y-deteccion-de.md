# 🛠 Ejercicio práctico — 5. Visualización rápida y detección de historias

> 📚 Pandas — Excel con Superpoderes en Python · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Visualización rápida y detección de historias** — sin copiar y pegar de la lección.
...
# Tema: 5. Visualización rápida y detección de historias
```
