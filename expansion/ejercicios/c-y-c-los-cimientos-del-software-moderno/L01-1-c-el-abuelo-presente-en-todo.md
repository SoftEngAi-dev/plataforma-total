# 🛠 Ejercicio práctico — 1. C: el abuelo presente en TODO

> 📚 C y C++ — Los Cimientos del Software Moderno · Lección 1 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**C: el abuelo presente en TODO** — sin copiar y pegar de la lección.
...
# Tema: 1. C: el abuelo presente en TODO
```
