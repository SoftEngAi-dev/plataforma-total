# 🛠 Ejercicio práctico — 5. Proyecto: programa C completo leyendo archivos

> 📚 C y C++ — Los Cimientos del Software Moderno · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: programa C completo leyendo archivos** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.cpp`) y escribe el código desde cero.
...
# Tema: 5. Proyecto: programa C completo leyendo archivos
```
