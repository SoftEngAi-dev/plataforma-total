# 🛠 Ejercicio práctico — 4. Compilar y depurar: gcc, make y headers

> 📚 C y C++ — Los Cimientos del Software Moderno · Lección 4 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Compilar y depurar: gcc, make y headers** — sin copiar y pegar de la lección.
...
# Tema: 4. Compilar y depurar: gcc, make y headers
```
