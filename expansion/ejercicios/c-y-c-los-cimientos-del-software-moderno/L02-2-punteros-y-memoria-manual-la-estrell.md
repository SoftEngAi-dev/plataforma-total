# 🛠 Ejercicio práctico — 2. Punteros y memoria manual: la estrella de C

> 📚 C y C++ — Los Cimientos del Software Moderno · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Punteros y memoria manual: la estrella de C** — sin copiar y pegar de la lección.
...
# Tema: 2. Punteros y memoria manual: la estrella de C
```
