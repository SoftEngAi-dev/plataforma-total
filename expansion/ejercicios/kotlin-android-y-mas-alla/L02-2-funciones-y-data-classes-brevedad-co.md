# 🛠 Ejercicio práctico — 2. Funciones y data classes: brevedad con tipos

> 📚 Kotlin — Android y Más Allá · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Funciones y data classes: brevedad con tipos** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.kt`) y escribe el código desde cero.
...
# Tema: 2. Funciones y data classes: brevedad con tipos
```
