# 🛠 Ejercicio práctico — 5. Proyecto: app mínima con Compose

> 📚 Kotlin — Android y Más Allá · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: app mínima con Compose** — sin copiar y pegar de la lección.
...
# Tema: 5. Proyecto: app mínima con Compose
```
