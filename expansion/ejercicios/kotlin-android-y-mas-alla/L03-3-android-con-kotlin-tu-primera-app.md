# 🛠 Ejercicio práctico — 3. Android con Kotlin: tu primera app

> 📚 Kotlin — Android y Más Allá · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Android con Kotlin: tu primera app** — sin copiar y pegar de la lección.
...
# Tema: 3. Android con Kotlin: tu primera app
```
