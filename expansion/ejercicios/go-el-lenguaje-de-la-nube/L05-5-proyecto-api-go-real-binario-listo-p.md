# 🛠 Ejercicio práctico — 5. Proyecto: API Go real + binario listo para producción

> 📚 Go — El Lenguaje de la Nube · Lección 5 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Proyecto: API Go real + binario listo para producción** — sin copiar y pegar de la lección.

## 📋 Pasos
1. **Recuerda**: cierra la lección e intenta escribir la idea central en una frase.
2. **Construye**: crea un archivo nuevo (`ejercicio.go`) y escribe el código desde cero.
...
# Tema: 5. Proyecto: API Go real + binario listo para producción
```
