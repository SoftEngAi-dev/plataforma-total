# 🛠 Ejercicio práctico — 2. Errores a la vista: el if err != nil filosófico

> 📚 Go — El Lenguaje de la Nube · Lección 2 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Errores a la vista: el if err != nil filosófico** — sin copiar y pegar de la lección.
...
# Tema: 2. Errores a la vista: el if err != nil filosófico
```
