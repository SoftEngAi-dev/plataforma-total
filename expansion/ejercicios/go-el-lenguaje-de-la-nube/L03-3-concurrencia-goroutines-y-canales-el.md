# 🛠 Ejercicio práctico — 3. Concurrencia: goroutines y canales (el superpoder)

> 📚 Go — El Lenguaje de la Nube · Lección 3 · 🍅 1-2 pomodoros · Método: aprender construyendo

## 🎯 Objetivo
Construir un ejemplo REAL y ejecutable que demuestre que puedes usar:
**Concurrencia: goroutines y canales (el superpoder)** — sin copiar y pegar de la lección.
...
# Tema: 3. Concurrencia: goroutines y canales (el superpoder)
```
