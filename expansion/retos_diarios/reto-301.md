...
> Hoy tu cerebro ataca: **10. map, filter, reduce: programar sin bucles** (JavaScript — De Cero a Experto)
...
**¿Qué devuelve [2,4,6].filter(n => n > 3)?**

<details><summary>👁 Ver respuesta</summary>

✅ [4, 6] — filter conserva los que cumplen la condición.
</details>
