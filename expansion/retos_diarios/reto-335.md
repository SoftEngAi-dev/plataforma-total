...
> Hoy tu cerebro ataca: **5. Strings: métodos que usarás a diario** (Python — De Cero a Profesional)
...
**'a-b-c'.split('-') devuelve...**

<details><summary>👁 Ver respuesta</summary>

✅ ['a', 'b', 'c'] — split corta en lista; el inverso es '-'.join(lista).
</details>
