...
> Hoy tu cerebro ataca: **3. Ordenar, limitar y funciones agregadas** (SQL y Bases de Datos — Datos que Persisten)
...
✅ Número TOTAL de filas (incluyendo nulos) — COUNT(*) cuenta filas; COUNT(columna) omite las NULL.
</details>
